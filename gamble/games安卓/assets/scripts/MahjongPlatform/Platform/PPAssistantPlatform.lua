--region PPAssistantPlatform .lua
--Author : BillyYang
--Date   : 2015/1/23
--此文件由[BabeLua]插件自动生成
...
PPAssistantPlatform = class(BasePlatform);
...
PPAssistantPlatform.ctor = function ( self)
	self.m_loginMethods = {};
	self.curDefaultPmode = 515; --默认为MOBILE的商品
	self.m_loginTable = { PlatformConfig.QQLogin, PlatformConfig.BoyaaLogin,PlatformConfig.GuestLogin};
end

-- 获取应用APPID信息
-- @Override
PPAssistantPlatform.getLoginAppId = function( self, loginType )
...
PPAssistantPlatform.dtor = function ( self )
end

PPAssistantPlatform.returnIsLianyunName = function(self)
	return PlatformConfig.feedback_platform_3Net_PPAssistant;
end

PPAssistantPlatform.isNeedPostApiHost = function(self)
	return true;
end
...
PPAssistantPlatform.getLoginView = function (self)
	return new(PPAssistantPlatformView,self.m_loginTable);
end

--是否显示绑定博雅通行证
PPAssistantPlatform.isNeedToShowBYPassCard = function ( self )
	-- body
...
PPAssistantPlatform.getDefaultLoginMethod = function ( self )
	local loginType = g_DiskDataMgr:getAppData(kLastLoginType, PlatformConfig.GuestLogin);
	return loginType;
end

PPAssistantPlatform.changeLoginMethod = function(self,loginMethod)
...
--*****************************************************View平台界面********************************************************************************--
--[[
	className    	     :  PPAssistantPlatform View
	Description  	     :  平台界面类
...
PPAssistantPlatformView = class(CustomNode);

--[[
	function name	   : PPAssistantPlatform View.ctor
	description  	   : Construct the class.
	param 	 	 	   : self
	last-modified-date : Dec. 2 2013
	create-time  	   : Oct.22 2013
]]
PPAssistantPlatformView.ctor = function(self, loginTable)
...
--[[
	function name	   : PPAssistantPlatform View.dtor
	description  	   : Destruct the class.
	param 	 	 	   : self
	last-modified-date : Dec. 2 2013
	create-time  	   : Oct.22 2013
]]
PPAssistantPlatformView.dtor = function(self)
	CustomNode.hide(self);
	self:removeAllChildren();
end

--[[
	function name	   : PPAssistantPlatform View.onClick
	description  	   : Destruct the class.
	param 	 	 	   : self
	last-modified-date : Dec. 2 2013
	create-time  	   : Oct.22 2013
]]
PPAssistantPlatformView.onClick = function(self, loginMethod)
...
--[[
	function name	   : PPAssistantPlatform View.createGuestBtn
	description  	   : create the Button of the guest.
	param 	 	 	   : self
	last-modified-date : Dec. 2 2013
	create-time  	   : Oct.22 2013
]]
PPAssistantPlatformView.createGuestBtn = function ( self )
	local btn = nil;
...
--[[
	function name	   : PPAssistantPlatform View.createQQBtn
	description  	   : create the Button of the QQ.
	param 	 	 	   : self
	last-modified-date : Dec. 2 2013
	create-time  	   : Oct.22 2013
]]
PPAssistantPlatformView.createQQBtn = function ( self )
	local btn = nil;
...
--[[
	function name	   : PPAssistantPlatform View.createSinaBtn
	description  	   : create the Button of the Sina.
	param 	 	 	   : self
	last-modified-date : Dec. 2 2013
	create-time  	   : Oct.22 2013
]]
PPAssistantPlatformView.createSinaBtn = function ( self )
	local btn = nil;
...
--[[
	function name	   : PPAssistantPlatform View.createBoyaaBtn
	description  	   : create the Button of the Boyaa.
	param 	 	 	   : self
	last-modified-date : Dec. 2 2013
	create-time  	   : Oct.22 2013
]]
PPAssistantPlatformView.createBoyaaBtn = function ( self )
	local btn = nil;
...
--[[
	function name	   : PPAssistantPlatform View.createWeChatBtn
	description  	   : create the Button of the WeChat.
	param 	 	 	   : self
	last-modified-date : Dec. 2 2013
	create-time  	   : Oct.22 2013
]]
PPAssistantPlatformView.createWeChatBtn = function ( self )
	local btn = nil;
...
--主平台的登录方式列表
PPAssistantPlatformView.loginBtnCreateFunMap = {
	[PlatformConfig.QQLogin] 	= PPAssistantPlatformView.createQQBtn,
	[PlatformConfig.BoyaaLogin] = PPAssistantPlatformView.createBoyaaBtn,
	[PlatformConfig.GuestLogin] = PPAssistantPlatformView.createGuestBtn
};

--返回该平台对应的强制更新界面、首冲大礼包、普通更新界面、公告、签到界面的level
--强更>首冲>普更>公告>签到
PPAssistantPlatform.getPlatformLevel = function(self)
	return 20000,15000,10000,8000,6000;
end

-- 该平台的应用名称
-- @Override
PPAssistantPlatform.getApplicationShareName = function( self )
	return "博雅四川麻将";
end
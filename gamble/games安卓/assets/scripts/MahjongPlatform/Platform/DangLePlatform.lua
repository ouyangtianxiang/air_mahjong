...
DangLePlatform = class(BasePlatform);

--[[
	function name	   : DangLePlatform.ctor
...
DangLePlatform.ctor = function ( self)
	...
	PayConfigDataManager.getInstance().m_verData = {
		...
		PlatformConfig.HuaFuBaoPay,PlatformConfig.LoveAnimatePay,
...
-- 获取应用APPID信息
-- @Override
DangLePlatform.getLoginAppId = function( self, loginType )
	return "186";
end

--是否要调用平台自己的离开方法
DangLePlatform.isUsePlatformExit = function(self)
...
--[[
	function name	   : DangLePlatform.dtor
	description  	   : Destructor a class.
	param 	 	 	   : self
	last-modified-date : Oct.22 2013
	create-time  	   : Oct.22 2013
]]
DangLePlatform.dtor = function ( self )
end

DangLePlatform.returnIsLianyunName = function(self)
	return PlatformConfig.feedback_platform_Trunk;
end

DangLePlatform.isNeedPostApiHost = function(self)
	return true;
end

DangLePlatform.getUnicomChannelId = function(self)
	return true;
end
...
DangLePlatform.getLoginView = function (self)
	return new(DangLePlatformView,self.m_loginTable);
end

--是否显示绑定博雅通行证
DangLePlatform.isNeedToShowBYPassCard = function ( self )
	-- body
	DebugLog("DangLePlatform.isNeedToShowBYPassCard")
...
--[[
	function name	   : DangLePlatform.getDefaultLoginMethod
	description  	   : @Override.
	param 	 	 	   : self
	last-modified-date : Oct.22 2013
	create-time  	   : Oct.22 2013
]]
DangLePlatform.getDefaultLoginMethod = function ( self )
...
DangLePlatform.changeLoginMethod = function(self,loginMethod)
...
DangLePlatform.isNeedChangeXueZhanLogo = function( self )
	return false;
end

DangLePlatform.isUsePHPCheckMethod = function(self)
	return false;
end

--*****************************************************View平台界面********************************************************************************--
--[[
	className    	     :  DangLePlatformView
	Description  	     :  平台界面类
	last-modified-date   :  Dec.2  2013
	create-time 	     :  Oct.22 2013
	last-modified-author :  ClarkWu
...
DangLePlatformView = class(BasePlatformView);

--[[
	function name	   : DangLePlatformView.createGuestBtn
	description  	   : create the Button of the guest.
	param 	 	 	   : self
	last-modified-date : Dec. 2 2013
	create-time  	   : Oct.22 2013
]]
DangLePlatformView.createGuestBtn = function ( self )
	local btn = nil;
...
DangLePlatformView.createNewGuestBtn = function ( self )
	local btn = nil;
	local btnData = CreatingViewUsingData.switchLoginView.vistorLoginBtn;
	btn = UICreator.createBtn(btnData.fileName, btnData.x, btnData.y, self, function ( self )
...
--[[
	function name	   : DangLePlatformView.createQQBtn
	description  	   : create the Button of the QQ.
	param 	 	 	   : self
	last-modified-date : Dec. 2 2013
	create-time  	   : Oct.22 2013
]]
DangLePlatformView.createQQBtn = function ( self )
	local btn = nil;
...
--[[
	function name	   : DangLePlatformView.createSinaBtn
	description  	   : create the Button of the Sina.
	param 	 	 	   : self
	last-modified-date : Dec. 2 2013
	create-time  	   : Oct.22 2013
]]
DangLePlatformView.createSinaBtn = function ( self )
	local btn = nil;
...
--[[
	function name	   : DangLePlatformView.createBoyaaBtn
	description  	   : create the Button of the Boyaa.
	param 	 	 	   : self
	last-modified-date : Dec. 2 2013
	create-time  	   : Oct.22 2013
]]
DangLePlatformView.createBoyaaBtn = function ( self )
	local btn = nil;
...
--[[
	function name	   : DangLePlatformView.createWeChatBtn
	description  	   : create the Button of the WeChat.
	param 	 	 	   : self
	last-modified-date : Dec. 2 2013
	create-time  	   : Oct.22 2013
]]
DangLePlatformView.createWeChatBtn = function ( self )
	local btn = nil;
...
--主平台的登录方式列表
DangLePlatformView.loginBtnCreateFunMap = {
	[PlatformConfig.SinaLogin] 	= DangLePlatformView.createSinaBtn,
	[PlatformConfig.QQLogin] 	= DangLePlatformView.createQQBtn,
	[PlatformConfig.BoyaaLogin] = DangLePlatformView.createBoyaaBtn,
	[PlatformConfig.WeChatLogin]= DangLePlatformView.createWeChatBtn,
	[PlatformConfig.GuestLogin] = DangLePlatformView.createGuestBtn,
	[PlatformConfig.NewGuestLogin] = DangLePlatformView.createNewGuestBtn
};

--返回该平台对应的强制更新界面、首冲大礼包、普通更新界面、公告、签到界面的level
--强更>首冲>普更>公告>签到
DangLePlatform.getPlatformLevel = function(self)

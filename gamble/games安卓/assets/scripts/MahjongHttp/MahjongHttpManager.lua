...
MahjongHttpManager = class(HttpManager);

MahjongHttpManager.ctor = function(self,configMap,postDataOrganizer,urlOrganizer)
	self.m_timeout  = 15000;
end

MahjongHttpManager.dtor = function(self)
	
end

MahjongHttpManager.execute = function(self,command,data,commonUrl)
	...
	local timeoutAnim = MahjongHttpManager.createTimeoutAnim(self, httpRequest.m_requestID, command,config[HttpConfigContants.TIMEOUT] or self.m_timeout);
...
MahjongHttpManager.onResponse = function(self , httpRequest)
...
MahjongHttpManager.createTimeoutAnim = function(self, requestID, command, timeoutTime)
...
MahjongHttpManager.onTimeout = function(callbackObj)

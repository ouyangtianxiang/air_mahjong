...
--BounceInOut
ResDoubleArrayBounceOnceOut = class(ResDoubleArray, false)

ResDoubleArrayBounceOnceOut.ctor = function(self,duration,startV,endV)
	endV = endV - startV;
    local arr = easing.getEaseArray("easeOutBounceOnce", duration, startV, endV);
    self.m_arrayLength = #arr;
    super(self, arr);
end 

ResDoubleArrayBounceOnceOut.dtor = function(self)
end

ResDoubleArrayBounceOnceOut.getLength = function(self)
	return self.m_arrayLength;
end 
...
EaseTypeMap["BounceOnceOut"]    = ResDoubleArrayBounceOnceOut;--反弹的效果表现为反弹一次

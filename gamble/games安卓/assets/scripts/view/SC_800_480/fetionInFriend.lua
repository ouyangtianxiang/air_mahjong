fetionInFriend=
{
	name="fetionInFriend",type=0,typeName="View",time=0,x=0,y=0,width=1280,height=800,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,
	{
		name="img_win_bg",type=1,typeName="Image",time=51435238,x=0,y=0,width=600,height=291,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,file="Common/windowsBg.png",gridLeft=50,gridRight=50,gridTop=85,gridBottom=50,
		{
		...
		{
			name="Image1",type=1,typeName="Image",time=59661923,x=0,y=0,width=500,height=150,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,file="Common/windowsFrame.png",gridLeft=20,gridRight=20,gridTop=20,gridBottom=20,
			{
			...
			},
			{
				...
				{
					name="Text1",type=4,typeName="Text",time=59706700,x=0,y=0,width=212,height=74,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,fontSize=34,textAlign=kAlignCenter,colorRed=255,colorGreen=255,colorBlue=255,string=[[飞信通知]]
				}
			},
			{
				...
				{
					name="Text2",type=4,typeName="Text",time=59706831,x=0,y=0,width=212,height=74,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,fontSize=34,textAlign=kAlignCenter,colorRed=255,colorGreen=255,colorBlue=255,string=[[短信通知]]
				}
			}
		}
	}

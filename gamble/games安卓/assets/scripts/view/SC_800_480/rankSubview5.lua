rankSubview5=
{
	name="rankSubview5",type=0,typeName="View",time=0,x=0,y=0,width=1280,height=800,visible=1,fillParentWidth=1,fillParentHeight=1,nodeAlign=kAlignTopLeft,
	{
	...
	},
	{
		name="sub_part",type=0,typeName="View",time=50739261,x=197,y=120,width=0,height=680,visible=1,fillParentWidth=1,fillParentHeight=0,nodeAlign=kAlignTopLeft,
		{
			name="sub_view",type=0,typeName="View",time=50739351,x=40,y=0,width=1200,height=680,fillTopLeftX=40,fillTopLeftY=10,fillBottomRightX=40,fillBottomRightY=0,visible=1,fillParentWidth=1,fillParentHeight=1,nodeAlign=kAlignTopLeft,
			{
				...
				{
					name="Text1",type=4,typeName="Text",time=51956483,x=0,y=0,width=0,height=0,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,fontSize=24,textAlign=kAlignCenter,colorRed=255,colorGreen=255,colorBlue=255,string=[[暂无排行记录]]
				}
			},
			{
...
--m_xxreference["D:_Mahjong_SCMahjong_Lua_SCMahjong_Lua_1.6_Resource_scripts_view_SC_800_480_rankSubview5.lua"]=1;

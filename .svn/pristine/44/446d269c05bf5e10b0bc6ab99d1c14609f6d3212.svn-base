...
function t(t) {
try {
if ("" + t == "[object CallbackConstructor]") return "function";
} catch (t) {}
return "object";
}
!(function(i, n, o) {
...
t(e + " " + i + ", please go to " + s + "#" + i + " to see details. " + n);
} else t(e + " " + i + ", please go to " + s + "#" + i + " to see details.");
};
}
cc._logToWebPage = function(t) {
if (cc._canvas) {
var e = cc._logList, i = document;
if (!e) {
var n = i.createElement("Div"), o = n.style;
...
o.top = "0";
o.left = "0";
var r = (e = cc._logList = i.createElement("textarea")).style;
...
var s = "https://github.com/cocos-creator/engine/blob/master/EngineErrorMap.md";
}), {
...
update: function(t) {
for (var e = this.target.getComponentsInChildren(cc._SGComponent), i = 0; i < e.length; ++i) e[i].enabled = !0;
},
reverse: function() {
return new cc.Hide();
},
...
update: function(t) {
for (var e = this.target.getComponentsInChildren(cc._SGComponent), i = 0; i < e.length; ++i) e[i].enabled = !1;
},
reverse: function() {
return new cc.Show();
},
...
function r(i, r, c) {
var h, f = i instanceof cc.Node && "position" === r, p = [];
(h = f ? new u() : new l()).target = i;
var _, g = r.indexOf(".");
-1 !== g ? i[_ = r.slice(0, g)] : _ = r;
h.prop = _;
h.subProps = s(r);
for (var v = 0, y = c.length; v < y; v++) {
var m = c[v], b = m.frame / n.duration;
h.ratios.push(b);
if (f) {
var C = m.motionPath;
if (C && !o(C)) {
...
if (Array.isArray(E)) {
E[0] === E[1] && E[2] === E[3] ? h.types.push(l.Linear) : h.types.push(l.Bezier(E));
continue;
}
}
h.types.push(l.Linear);
}
f && d(p, h, a.duration, a.sample);
return h;
}
function c(t, e) {
...
var a = n.clip, h = n.curves;
h.length = 0;
n.duration = a.duration;
n.speed = a.speed;
n.wrapMode = a.wrapMode;
n.frameRate = a.sample;
(n.wrapMode & _.Loop) === _.Loop ? n.repeatCount = Infinity : n.repeatCount = 1;
var v = a.curveData, y = v.paths;
c(i, v);
for (var m in y) {
var b = cc.find(m, i);
b && c(b, y[m]);
...
var C = a.events;
if (C) for (var T, E = 0, S = C.length; E < S; E++) {
if (!T) {
(T = new f()).target = i;
h.push(T);
}
var x, A = C[E], w = A.frame / n.duration, O = g(T.ratios, w);
if (O >= 0) x = T.events[O]; else {
x = new p();
T.ratios.push(w);
T.events.push(x);
}
x.add(A.func, A.params);
}
}
var a = cc.js, h = i("./animators").Animator, l = i("./animation-curves").DynamicAnimCurve, u = i("./animation-curves").SampledAnimCurve, d = i("./motion-path-helper").sampleMotionPaths, f = i("./animation-curves").EventAnimCurve, p = i("./animation-curves").EventInfo, _ = i("./types").WrapModeMask, g = i("../core/utils/binary-search").binarySearchEpsilon;
a.extend(r, h);
var v = r.prototype;
v.playState = function(i, n) {
if (i.clip) {
i.curveLoaded || c(this.target, i);
this.addAnimation(i);
i.animator = this;
i.play();
...
v.addAnimation = function(t) {
h.prototype.addAnimation.call(this, t);
for (var e = this.animation._listeners, i = 0, n = e.length; i < n; i++) {
var o = e[i];
t.on(o[0], o[1], o[2], o[3]);
}
};
v.removeAnimation = function(t) {
h.prototype.removeAnimation.call(this, t);
t.animator = null;
};
v.sample = function() {
...
v.stopState = function(t) {
t && t.stop();
};
v.pauseState = function(t) {
t && t.pause();
};
v.resumeState = function(t) {
t && t.resume();
this.isPaused && this.resume();
};
v.setStateTime = function(t, e) {
if (void 0 !== e) {
if (t) {
t.setTime(e);
t.sample();
...
e = t;
var i = this._anims, n = i.array;
for (i.i = 0; i.i < n.length; ++i.i) {
var o = n[i.i];
o.setTime(e);
o.sample();
}
...
h.prototype.onResume.call(this);
};
v._reloadClip = function(t) {
c(this.target, t);
};
n.exports = r;
}), {
...
_calcValue: function(i, n) {
var o = this.values, r = o[i - 1], s = o[i];
return "number" === ("object" == (e = typeof r) ? t(r) : e) ? r + (s - r) * n : r && r.lerp ? r.lerp(s, n) : r;
},
_applyValue: function(t, e, i) {
t[e] = i;
},
_findFrameIndex: c,
sample: function(t, e, i) {
var n = this.values, o = this.ratios, s = o.length;
if (0 !== s) {
var c, a = this._findFrameIndex(o, e);
if (a < 0) if ((a = ~a) <= 0) c = n[0]; else if (a >= s) c = n[s - 1]; else {
var h = o[a - 1], l = (e - h) / (o[a] - h);
l = r(l, this.types[a - 1]);
c = this._calcValue(a, l);
} else c = n[a];
var u = this.subProps;
if (u) {
for (var d = this.target[this.prop], f = d, p = 0; p < u.length - 1; p++) {
var _ = u[p];
if (!f) return;
f = f[_];
}
var g = u[u.length - 1];
if (!f) return;
this._applyValue(f, g, c);
c = d;
}
this._applyValue(this.target, this.prop, c);
}
}
});
u.Linear = null;
...
this._animators = new o.array.MutableForwardIterator([]);
this._delayEvents = [];
},
update: function(t) {
var e = this._animators, n = e.array;
...
-1 === this._animators.array.indexOf(t) && this._animators.push(t);
},
removeAnimator: function(t) {
var e = this._animators.array.indexOf(t);
e >= 0 ? this._animators.fastRemoveAt(e) : cc.errorID(3907);
},
...
var o = cc.js, r = t("./types").AnimationNode;
o.extend(n, r);
var s = n.prototype;
o.get(s, "clip", (function() {
return this._clip;
}));
o.get(s, "name", (function() {
return this._name;
}));
o.obsolete(s, "AnimationState.length", "duration");
o.getset(s, "curveLoaded", (function() {
...
function r(t) {
this.target = t;
this._anims = new l.array.MutableForwardIterator([]);
}
function s(t) {
r.call(this, t);
}
function c(i) {
for (var n = 0, o = 0, r = i.length, s = 0; s < r; s++) {
var c = i[s], a = c.ratio;
0 === s && "number" !== ("object" == (e = typeof a) ? t(a) : e) ? c.computedRatio = a = 0 : s === r - 1 && "number" !== ("object" == (e = typeof a) ? t(a) : e) && (c.computedRatio = a = 1);
if ("number" === ("object" == (e = typeof a) ? t(a) : e)) {
if (n + 1 < s) for (var h = (a - o) / (s - n), l = n + 1; l < s; l++) {
o += h;
i[l].computedRatio = o;
}
n = s;
...
function a(t, e, i) {
for (var n, o = 0; o < t.length; o++) if ((n = t[o]).target === e && n.prop === i) return n;
return null;
}
...
var l = cc.js, u = i("./playable"), d = i("./types").AnimationNode, f = i("./animation-curves").DynamicAnimCurve;
l.extend(r, u);
var p = r.prototype;
p.update = function(t) {
var e = this._anims, i = e.array, n = 0, o = i.length;
for (e.i = 0; e.i < i.length; ++e.i) {
var r = i[e.i];
if (r._isPlaying && !r._isPaused) {
r.update(t);
r._isPlaying || n++;
}
}
var s = n >= o;
(0 === i.length || s) && this.stop();
};
...
p.on = function(t, e, i, n) {
for (var o = this._anims.array, r = 0; r < o.length; ++r) o[r].on(t, e, i, n);
};
p.onPlay = function() {
...
e >= 0 ? this._anims.fastRemoveAt(e) : cc.errorID(3908);
};
l.extend(s, r);
var _ = s.prototype;
_.animate = function(t, e) {
if (!t) {
cc.errorID(3909);
return null;
}
c(t);
var i = this._doAnimate(t, e);
this.play();
return i;
};
_._doAnimate = function(i, n) {
var o = new d(this, null, n);
o.play();
for (var r = o.curves, s = -1, c = 0; c < i.length; c++) {
var a = i[c], l = a.ratio;
"number" !== ("object" == (e = typeof l) ? t(l) : e) && (l = a.computedRatio);
if (l < 0) cc.errorID(3910); else if (l < s) cc.errorID(3911); else {
s = l;
for (var u in a) {
var f = a[u];
if ("props" === u) for (var p in f) h(r, this.target, p, f[p], l); else if ("comps" === u) for (var _ in f) {
var g = this.target.getComponent(_), v = f[_];
for (var p in v) h(r, g, p, v[p], l);
}
}
}
}
...
function r(t, e) {
var i, n, r, s, d = e - 0, f = e - t[0], p = 3 * d, _ = 3 * f, g = 3 * (e - t[2]), v = 1 / (-d + _ - g + (e - 1)), y = (p - 6 * f + g) * v, m = y * (1 / 3), b = (-p + _) * v, C = 1 / 3 * (3 * b - y * y), T = C * (1 / 3), E = (2 * y * y * y - 9 * y * b + 27 * (d * v)) / 27, S = E / 2, x = S * S + T * T * T;
if (x < 0) {
var A = 1 / 3 * -C, w = u(A * A * A), O = -E / (2 * w), I = a(O < -1 ? -1 : O > 1 ? 1 : O), N = 2 * o(w);
n = N * c(I * (1 / 3)) - m;
r = N * c((I + l) * (1 / 3)) - m;
s = N * c((I + 2 * l) * (1 / 3)) - m;
return 0 <= n && n <= 1 ? 0 <= r && r <= 1 ? 0 <= s && s <= 1 ? h(n, r, s) : h(n, r) : 0 <= s && s <= 1 ? h(n, s) : n : 0 <= r && r <= 1 ? 0 <= s && s <= 1 ? h(r, s) : r : s;
}
if (0 === x) {
r = -(i = S < 0 ? o(-S) : -o(S)) - m;
return 0 <= (n = 2 * i - m) && n <= 1 ? 0 <= r && r <= 1 ? h(n, r) : n : r;
}
var L = u(x);
...
var c = Math.cos, a = Math.acos, h = Math.max, l = 2 * Math.PI, u = Math.sqrt;
e.exports = {
bezier: n,
bezierByTime: s
};
...
var C, T = t[m], E = f[m], S = f[m + 1] - E, x = u[m], A = u[m + 1], w = d[m], O = [], I = v / S, N = 1 / (S * i * o);
if (T && T.length > 0) {
var L = [];
L.push(r(x));
...
var D = new n(L);
D.computeBeziers();
for (var M = D.progresses; 1 - I > 1e-6; ) {
var F, j, k, z;
if ((C = c(C = I, w)) < 0) {
z = (0 - C) * (j = D.beziers[0]).getLength();
k = j.start.sub(j.endCtrlPoint).normalize();
F = j.start.add(k.mul(z));
} else if (C > 1) {
z = (C - 1) * (j = D.beziers[D.beziers.length - 1]).getLength();
k = j.end.sub(j.startCtrlPoint).normalize();
F = j.end.add(k.mul(z));
} else {
var W = h(M, C);
W < 0 && (W = ~W);
...
for (var r = 0, e = 0; e < this.beziers.length; e++) {
t = this.beziers[e];
...
if (n[o = a] === i) return l = o / (r - 1);
var h = n[o], l = (o + (i - h) / (n[o + 1] - h)) / (r - 1);
return l;
};
e.exports = {
sampleMotionPaths: r,
...
this.duration = 1;
this.speed = 1;
this.wrapMode = u.Normal;
if (o) {
this.delay = o.delay || this.delay;
var c = o.duration;
"undefined" !== ("object" == (e = typeof c) ? t(c) : e) && (this.duration = c);
var a = o.speed;
"undefined" !== ("object" == (e = typeof a) ? t(a) : e) && (this.speed = a);
var h = o.wrapMode;
if ("undefined" !== ("object" == (e = typeof h) ? t(h) : e)) {
var d = "number" === ("object" == (e = typeof h) ? t(h) : e);
this.wrapMode = d ? h : u[h];
}
var f = o.repeatCount;
"undefined" !== ("object" == (e = typeof f) ? t(f) : e) ? this.repeatCount = f : this.wrapMode & l.Loop && (this.repeatCount = Infinity);
}
this.time = 0;
}
var a = cc.js, h = i("./playable"), l = {
Loop: 2,
ShouldWrap: 4,
PingPong: 22,
Reverse: 36
...
Reverse: l.Reverse,
Loop: l.Loop,
LoopReverse: l.Loop | l.Reverse,
PingPong: l.PingPong,
PingPongReverse: l.PingPong | l.Reverse
});
cc.WrapMode = u;
...
var e = this.sample();
this._lastWrappedInfo || (this._lastWrappedInfo = new r(e));
var i = (0 | e.iterations) > (0 | this._lastWrappedInfo.iterations);
this.repeatCount > 1 && i && ((this.wrapMode & l.Reverse) === l.Reverse ? this._lastWrappedInfo.direction < 0 && this.emit("lastframe", this) : this._lastWrappedInfo.direction > 0 && this.emit("lastframe", this));
if (e.stopped) {
this.stop();
this.emit("finished", this);
}
this._lastWrappedInfo.set(e);
};
...
e = e || new r();
var i = !1, n = this.duration, o = 0, s = this.wrapMode, c = Math.abs(t / n);
c > this.repeatCount && (c = this.repeatCount);
var a = !1;
s & l.ShouldWrap && (a = this._needRevers(c));
var h = a ? -1 : 1;
this.speed < 0 && (h *= -1);
if (c >= this.repeatCount) {
i = !0;
var u = this.repeatCount - (0 | this.repeatCount);
0 === u && (u = 1);
t = u * n * (t > 0 ? 1 : -1);
}
if (t > n) {
...
var c = i("./utils/prefab-helper"), a = i("./utils/scene-graph-helper"), h = cc.Object.Flags.Destroying, l = i("./utils/misc"), u = i("./event/event"), d = !!cc.ActionManager, f = function() {}, p = cc.Enum({
...
}), _ = [ p.TOUCH_START, p.TOUCH_MOVE, p.TOUCH_END, p.TOUCH_CANCEL ], g = [ p.MOUSE_DOWN, p.MOUSE_ENTER, p.MOUSE_MOVE, p.MOUSE_LEAVE, p.MOUSE_UP, p.MOUSE_WHEEL ], v = null, y = function(t, e) {
e = u.EventTouch.pool.get(e);
var i = t.getLocation(), n = this.owner;
if (n._hitTest(i, this)) {
e.type = p.TOUCH_START;
e.touch = t;
e.bubbles = !0;
n.dispatchEvent(e);
return !0;
...
e = u.EventTouch.pool.get(e);
var i = t.getLocation(), n = this.owner;
n._hitTest(i, this) ? e.type = p.TOUCH_END : e.type = p.TOUCH_CANCEL;
e.touch = t;
e.bubbles = !0;
n.dispatchEvent(e);
}, C = function(t) {
...
t.stopPropagation();
(t = u.EventMouse.pool.get(t)).type = p.MOUSE_DOWN;
i.dispatchEvent(t);
}
}, T = function(t) {
var e = t.getLocation(), i = this.owner;
...
if (!this._previousIn) {
if (v) {
t.type = p.MOUSE_LEAVE;
v.dispatchEvent(t);
v._mouseListener._previousIn = !1;
}
v = this.owner;
t.type = p.MOUSE_ENTER;
i.dispatchEvent(t);
this._previousIn = !0;
}
t.type = p.MOUSE_MOVE;
...
(t = u.EventMouse.pool.get(t)).type = p.MOUSE_LEAVE;
i.dispatchEvent(t);
this._previousIn = !1;
v = null;
}
...
if (i._hitTest(e, this)) {
t.stopPropagation();
(t = u.EventMouse.pool.get(t)).type = p.MOUSE_UP;
i.dispatchEvent(t);
}
}, S = function(t) {
var e = t.getLocation(), i = this.owner;
if (i._hitTest(e, this)) {
(t = u.EventMouse.pool.get(t)).type = p.MOUSE_WHEEL;
i.dispatchEvent(t);
}
}, x = cc.Class({
name: "cc.Node",
...
var i = this._capturingListeners && this._capturingListeners._callbackTable["position-changed"], n = this._bubblingListeners && this._bubblingListeners._callbackTable["position-changed"];
(i && i.length > 0 || n && n.length > 0) && this.emit("position-changed");
}
}
},
y: {
...
statics: {
isNode: function(t) {
return t instanceof x && (t.constructor === x || !(t instanceof cc.Scene));
}
},
...
var t = this._prefab;
t && t.sync && !t._synced && t.root === this && c.syncWithPrefab(this);
...
-1 !== _.indexOf(t) ? this._checkTouchListeners() : -1 !== g.indexOf(t) && this._checkMouseListeners();
},
...
var t = 0;
if (this._bubblingListeners) for (;t < _.length; ++t) if (this._bubblingListeners.has(_[t])) return;
if (this._capturingListeners) for (;t < _.length; ++t) if (this._capturingListeners.has(_[t])) return;
...
var s = this._capturingListeners && this._capturingListeners._callbackTable["position-changed"], c = this._bubblingListeners && this._bubblingListeners._callbackTable["position-changed"];
(s && s.length > 0 || c && c.length > 0) && this.emit("position-changed");
}
},
getScale: function() {
...
_removeSgNode: a.removeSgNode,
onRestore: !1
}), A = function() {
this._activeInHierarchy || cc.eventManager.pauseTarget(this);
};
cc.js.getset(x.prototype, "_sgNode", (function() {
...
cc.director.once(cc.Director.EVENT_BEFORE_UPDATE, A, this);
}
}), !0);
var w = [ "parent", "tag", "skewX", "skewY", "position", "rotation", "rotationX", "rotationY", "scale", "scaleX", "scaleY", "opacity", "color" ], O = {
...
"../sprites/CCSpriteFrame": 218,
"../textures/CCTexture2D": 218,
"./CCAsset": 25,
"./CCAudioClip": 26,
"./CCBitmapFont": 27,
"./CCFont": 28,
...
var S = e._isAbsHorizontalCenter ? e._horizontalCenter : e._horizontalCenter * b, x = (.5 - f.x) * a.width;
if (c) {
S *= s.x;
x += r.x;
x *= s.x;
...
w += e._isAbsBottom ? e._bottom : e._bottom * O;
...
g = P + (N - .5) * I + R;
} else g = e.isAlignBottom ? w + N * I : A + (N - 1) * I;
}
}
t.setPosition(_, g);
}
...
for (var t = this._sgTarges, e = 0; e < t.length; e++) t[e].markTransformUpdated();
},
...
S = cc.pointApplyAffineTransform(t.offset, o);
i.position.x = S.x;
i.position.y = S.y;
o.tx = o.ty = 0;
s.x = t.radius;
s.y = 0;
var y = cc.pointApplyAffineTransform(s, o), m = Math.sqrt(y.x * y.x + y.y * y.y);
i.radius = m;
n.x = S.x - m;
n.y = S.y - m;
n.width = 2 * m;
...
var b = t.points, C = i.points;
C.length = b.length;
for (var p = 1e6, _ = 1e6, g = -1e6, v = -1e6, T = 0, E = b.length; T < E; T++) {
C[T] || (C[T] = cc.v2());
s.x = b[T].x + e.x;
s.y = b[T].y + e.y;
var S = cc.pointApplyAffineTransform(s, o);
C[T].x = S.x;
C[T].y = S.y;
S.x > g && (g = S.x);
S.x < p && (p = S.x);
...
function o(t, e, i) {
for (var o = i.length, r = 0; r < o; ++r) if (n(t, e, i[r], i[(r + 1) % o])) return !0;
return !1;
}
function r(t, e) {
...
function c() {
this.startInvoker = new f(s("c.start();c._objFlags|=" + l));
this.updateInvoker = new p(s("c.update(dt)", !0));
this.lateUpdateInvoker = new p(s("c.lateUpdate(dt)", !0));
this.scheduleInNextFrame = [];
this._updating = !1;
}
t("./platform/CCClass");
var a = t("./platform/CCObject").Flags, h = t("./platform/js").array, l = a.IsStartCalled, u = a.IsOnEnableCalled, d = (a.IsEditorOnEnableCalled, 
cc.Class({
__ctor__: function(t) {
...
var i = e < 0 ? this._neg.array : this._pos.array, o = n(i, t);
o < 0 && i.splice(~o, 0, t);
}
},
remove: function(t) {
...
var i = e < 0 ? this._neg : this._pos, o = n(i.array, t);
o >= 0 && i.removeAt(o);
}
},
invoke: function(t) {
...
this._init();
var i;
for (var n in this._nameToState) if ((i = this._nameToState[n]).clip === t) break;
...
on: function(t, e, i, n) {
this._init();
for (var o = this._listeners, r = 0, s = o.length; r < s; r++) {
var c = o[r];
if (c[0] === t && c[1] === e && c[2] === i && c[3] === n) return;
}
this._animator.on(t, e, i, n);
o.push([ t, e, i, n ]);
return e;
},
off: function(t, e, i, n) {
this._init();
for (var o = this._listeners, r = this._nameToState, s = o.length - 1; s >= 0; s--) {
var c = o[s];
if (c[0] === t && c[1] === e && c[2] === i && c[3] === n) {
for (var a in r) r[a].off(t, e, i, n);
o.splice(s, 1);
}
}
},
...
isPlaying: {
get: function() {
return !!this.audio && this.audio.getState() === cc.Audio.State.PLAYING;
},
visible: !1
},
clip: {
...
o.instance = this;
if (this.node._sizeProvider) ; else this.node._sizeProvider = n;
...
n = n || 0;
cc.director.getScheduler().schedule(t, this, e, i, n, !this.enabledInHierarchy);
},
...
this.backgroundImage ? this._createBackgroundSprite().setContentSize(t.getContentSize()) : e.removeFromParent();
}
},
returnType: {
default: n.DEFAULT,
...
"../label/CCSGLabel": 218,
"../label/CCSGLabelCanvasRenderCmd": 218,
"../label/CCSGLabelWebGLRenderCmd": 218
} ],
57: [ (function(t, e, i) {
var n = cc.Class({
...
var T = l * (1 - C) * h.width;
if (e) {
var E = f + T + l * (l > 0 ? this.paddingRight : this.paddingLeft), S = this.horizontalDirection === c.LEFT_TO_RIGHT && E > (1 - a.x) * t, x = this.horizontalDirection === c.RIGHT_TO_LEFT && E < -a.x * t;
if (S || x) {
if (h.height >= _) {
0 === g && (g = _);
p += g;
...
var A = i(h, p, v);
t >= h.width + this.paddingLeft + this.paddingRight && r && h.setPosition(cc.p(f, A));
var w, O = 1, I = 0 === _ ? h.height : _;
if (this.verticalDirection === s.TOP_TO_BOTTOM) {
y = y || this.node._contentSize.height;
(w = A + (O = -1) * (I * m + this.paddingBottom)) < y && (y = w);
} else {
y = y || -this.node._contentSize.height;
(w = A + O * (I * m + this.paddingTop)) > y && (y = w);
}
f += T;
}
}.bind(this));
...
if (e) {
var E = f + T + l * (l > 0 ? this.paddingTop : this.paddingBottom), S = this.verticalDirection === s.BOTTOM_TO_TOP && E > (1 - a.y) * t, x = this.verticalDirection === s.TOP_TO_BOTTOM && E < -a.y * t;
if (S || x) {
if (h.width >= _) {
0 === g && (g = _);
p += g;
...
var A = i(h, p, v);
t >= h.height + (this.paddingTop + this.paddingBottom) && r && h.setPosition(cc.p(A, f));
var w, O = 1, I = 0 === _ ? h.width : _;
if (this.horizontalDirection === c.RIGHT_TO_LEFT) {
O = -1;
y = y || this.node._contentSize.width;
(w = A + O * (I * m + this.paddingLeft)) < y && (y = w);
} else {
y = y || -this.node._contentSize.width;
(w = A + O * (I * m + this.paddingRight)) > y && (y = w);
}
f += T;
}
}.bind(this));
...
if (this.type === o.IMAGE_STENCIL && (cc._renderType, cc.game.RENDER_TYPE_WEBGL), 
1) {
...
"../../clipping-nodes/CCClippingNode": 218,
"../../clipping-nodes/CCClippingNodeCanvasRenderCmd": 218,
"../../clipping-nodes/CCClippingNodeWebGLRenderCmd": 218
} ],
60: [ (function(t, e, i) {
var n = cc.Enum({
Unified: 0,
...
var t = this._pages.length, e = this.content.getComponent(cc.Layout);
...
this.direction === o.Horizontal ? this._scrollCenterOffsetX[i] = Math.abs(this.content.x + this._pages[i].x) : this._scrollCenterOffsetY[i] = Math.abs(this.content.y + this._pages[i].y);
}
...
t.getChildrenCount() > 0 && t.removeAllChildren(!1);
...
var n, o = e;
if (this._lineOffsetX > 0 && o + this._lineOffsetX > this.maxWidth) for (var r = 0; this._lineOffsetX <= this.maxWidth; ) {
var s = this._getFirstWordLen(t, r, t.length), c = t.substr(r, s), a = this._measureText(i, c);
if (!(this._lineOffsetX + a <= this.maxWidth)) {
if (r > 0) {
var h = t.substr(0, r);
this._addLabelSegment(h, i);
t = t.substr(r, t.length);
o = this._measureText(i, t);
}
...
if (o > this.maxWidth) for (var l = cc.TextUtils.fragmentText(t, o, this.maxWidth, this._measureText(i)), u = 0; u < l.length; ++u) {
var d = l[u], f = (n = this._addLabelSegment(d, i)).getContentSize();
...
"scroll-ended": r.AUTOSCROLL_ENDED,
"touch-up": r.TOUCH_UP,
...
var n = -1;
i.y > 0 ? this.content.y - this.content.anchorY * this.content.height + i.y > this._bottomBoundary && (n = "scroll-to-bottom") : i.y < 0 ? this.content.y - this.content.anchorY * this.content.height + this.content.height + i.y <= this._topBoundary && (n = "scroll-to-top") : i.x < 0 ? this.content.x - this.content.anchorX * this.content.width + this.content.width + i.x <= this._rightBoundary && (n = "scroll-to-right") : i.x > 0 && this.content.x - this.content.anchorX * this.content.width + i.x >= this._leftBoundary && (n = "scroll-to-left");
this._moveContent(i, !1);
0 === i.x && 0 === i.y || this._dispatchEvent("scrolling");
...
this._autoScrollAttenuate && (o = n(o));
var r = cc.pAdd(this._autoScrollStartPosition, cc.pMult(this._autoScrollTargetDelta, o)), s = Math.abs(o - 1) <= 1e-4;
...
var a = cc.pSub(r, this.getContentPosition()), h = this._getHowMuchOutOfBoundary(a);
if (!cc.pFuzzyEqual(h, cc.p(0, 0), 1e-4)) {
r = cc.pAdd(r, h);
s = !0;
}
}
s && (this._autoScrolling = !1);
var l = cc.pSub(r, this.getContentPosition());
this._moveContent(l, s);
...
if (c.CUSTOM !== this._sizeMode && this._spriteFrame) if (c.RAW === this._sizeMode) {
...
} else this.node.setContentSize(this.node.getContentSize(!0)); else this.node.setContentSize(this.node.getContentSize(!0));
},
...
_resized: !1
}), h = [ "insetLeft", "insetTop", "insetRight", "insetBottom" ], l = {
type: [ null, "setRenderingType" ]
};
t("../utils/misc").propertyDefine(a, h, l);
...
"../videoplayer/CCSGVideoPlayer": 218
} ],
76: [ (function(t, e, i) {
var n = cc.Class({
name: "cc.ViewGroup",
...
80: [ (function(t, e, i) {
var n = cc.js, o = t("../utils/misc").isBuiltinClassId, r = cc.Class({
...
return e.node && (/^[0-9a-zA-Z+/]{23}$/.test(t) || o(t)) ? s : r;
}
},
onLoad: function() {
...
var s = cc.js, c = i("../platform/callbacks-invoker").CallbacksHandler, a = c.REMOVE_PLACEHOLDER;
s.extend(r, c);
r.prototype.invoke = function(i, n) {
var o, r, s, c, h = i.type, l = this._callbackTable[h];
this._invoking[h] = !0;
if (l) if (1 === l.length) (s = l[0]) !== a && s.call(i.currentTarget, i, n); else {
r = l.length - 1;
for (o = 0; o <= r; ) {
var u = 1;
if ((s = l[o]) !== a) {
if ((c = l[o + 1]) && "object" === ("object" == (e = typeof c) ? t(c) : e)) {
s.call(c, i, n);
u = 2;
} else s.call(i.currentTarget, i, n);
if (i._propagationImmediateStopped || o + u > r) break;
}
o += u;
}
}
this._invoking[h] = !1;
this._clearToRemove(h);
};
n.exports = r;
}), {
...
return !!(e && this._capturingListeners && this._capturingListeners.has(t)) || !(e || !this._bubblingListeners || !this._bubblingListeners.has(t));
};
...
l.emit = function(t, e) {
var i = this._capturingListeners && this._capturingListeners._callbackTable[t], n = this._bubblingListeners && this._bubblingListeners._callbackTable[t];
if (i && 0 !== i.length || n && 0 !== n.length) {
var o = cc.Event.EventCustom.get(t);
o.detail = e;
o.eventPhase = 2;
o.target = o.currentTarget = this;
i && this._capturingListeners.invoke(o);
n && !o._propagationImmediateStopped && this._bubblingListeners.invoke(o);
...
function n(t, e, i) {
i = i || 2;
var n = e && e.length, r = n ? e[0] * i : t.length, c = o(t, 0, r, i, !0), a = [];
if (!c) return a;
var h, l, d, f, p, _, g;
n && (c = u(t, e, c, i));
if (t.length > 80 * i) {
...
var r, s;
if (o === L(t, e, i, n) > 0) for (r = e; r < i; r += n) s = O(r, t[r], t[r + 1], s); else for (r = i - n; r >= e; r -= n) s = O(r, t[r], t[r + 1], s);
if (s && T(s, s.next)) {
I(s);
s = s.next;
}
...
d ? 1 === d ? s(t = h(t, e, i), e, i, n, o, u, 2) : 2 === d && l(t, e, i, n, o, u) : s(r(t), e, i, n, o, u, 1);
break;
}
}
}
...
if (m(e.x, e.y, i.x, i.y, n.x, n.y, o.x, o.y) && C(o.prev, o, o.next) >= 0) return !1;
o = o.next;
}
return !0;
}
function a(t, e, i, n) {
var o = t.prev, r = t, s = t.next;
if (C(o, r, s) >= 0) return !1;
for (var c = o.x < r.x ? o.x < s.x ? o.x : s.x : r.x < s.x ? r.x : s.x, a = o.y < r.y ? o.y < s.y ? o.y : s.y : r.y < s.y ? r.y : s.y, h = o.x > r.x ? o.x > s.x ? o.x : s.x : r.x > s.x ? r.x : s.x, l = o.y > r.y ? o.y > s.y ? o.y : s.y : r.y > s.y ? r.y : s.y, u = v(c, a, e, i, n), d = v(h, l, e, i, n), f = t.nextZ; f && f.z <= d; ) {
if (f !== t.prev && f !== t.next && m(o.x, o.y, r.x, r.y, s.x, s.y, f.x, f.y) && C(f.prev, f, f.next) >= 0) return !1;
f = f.nextZ;
}
f = t.prevZ;
for (;f && f.z >= u; ) {
...
var n = t;
do {
var o = n.prev, r = n.next.next;
if (!T(o, r) && E(o, n, n.next, r) && x(o, r) && x(r, o)) {
e.push(o.i / i);
e.push(n.i / i);
e.push(r.i / i);
I(n);
...
(a = o(t, e[s] * n, s < c - 1 ? e[s + 1] * n : t.length, n, !1)) === a.next && (a.steiner = !0);
h.push(y(a));
}
h.sort(d);
...
function p(t, e) {
var i, n = e, o = t.x, r = t.y, s = -Infinity;
do {
if (r <= n.y && r >= n.next.y) {
var c = n.x + (r - n.y) * (n.next.x - n.x) / (n.next.y - n.y);
if (c <= o && c > s) {
s = c;
if (c === o) {
if (r === n.y) return n;
...
if (!i) return null;
if (o === s) return i.prev;
var a, h = i, l = i.x, u = i.y, d = Infinity;
n = i.next;
for (;n !== h; ) {
if (o >= n.x && n.x >= l && m(r < u ? o : s, r, l, u, r < u ? s : o, r, n.x, n.y) && ((a = Math.abs(r - n.y) / (o - n.x)) < d || a === d && n.x > i.x) && x(n, t)) {
i = n;
d = a;
}
n = n.next;
...
return (t = 1431655765 & ((t = 858993459 & ((t = 252645135 & ((t = 16711935 & ((t = 32767 * (t - i) / o) | t << 8)) | t << 4)) | t << 2)) | t << 1)) | (e = 1431655765 & ((e = 858993459 & ((e = 252645135 & ((e = 16711935 & ((e = 32767 * (e - n) / o) | e << 8)) | e << 4)) | e << 2)) | e << 1)) << 1;
}
function y(t) {
var e = t, i = t;
do {
...
function m(t, e, i, n, o, r, s, c) {
return (o - s) * (e - c) - (t - s) * (r - c) >= 0 && (t - s) * (n - c) - (i - s) * (e - c) >= 0 && (i - s) * (r - c) - (o - s) * (n - c) >= 0;
}
function b(t, e) {
return t.next.i !== e.i && t.prev.i !== e.i && !S(t, e) && x(t, e) && x(e, t) && A(t, e);
}
function C(t, e, i) {
...
function A(t, e) {
var i = t, n = !1, o = (t.x + e.x) / 2, r = (t.y + e.y) / 2;
do {
i.y > r != i.next.y > r && o < (i.next.x - i.x) * (r - i.y) / (i.next.y - i.y) + i.x && (n = !n);
i = i.next;
} while (i !== t);
return n;
}
function w(t, e) {
var i = new N(t.i, t.x, t.y), n = new N(e.i, e.x, e.y), o = t.next, r = e.prev;
t.next = e;
e.prev = t;
i.next = o;
o.prev = i;
...
function L(t, e, i, n) {
for (var o = 0, r = e, s = i - n; r < i; r += n) {
o += (t[s] - t[r]) * (t[r + 1] + t[s + 1]);
s = r;
}
return o;
}
...
var o = e && e.length, r = o ? e[0] * i : t.length, s = Math.abs(L(t, 0, r, i));
if (o) for (var c = 0, a = e.length; c < a; c++) {
var h = e[c] * i, l = c < a - 1 ? e[c + 1] * i : t.length;
s -= Math.abs(L(t, h, l, i));
}
var u = 0;
for (c = 0; c < n.length; c += 3) {
var d = n[c] * i, f = n[c + 1] * i, p = n[c + 2] * i;
u += Math.abs((t[d] - t[p]) * (t[f + 1] - t[d + 1]) - (t[d] - t[f]) * (t[p + 1] - t[d + 1]));
}
...
for (var r = 0; r < t[o].length; r++) for (var s = 0; s < e; s++) i.vertices.push(t[o][r][s]);
if (o > 0) {
n += t[o - 1].length;
i.holes.push(n);
}
...
88: [ (function(i, n, o) {
cc.js;
var r = i("./types").LineCap, s = i("./types").LineJoin, c = i("./helper"), a = function(t) {
this._rootCtor(t);
this._needDraw = !0;
this.cmds = [];
this.style = {
...
}, h = a.prototype = Object.create(_ccsg.Node.CanvasRenderCmd.prototype);
h.constructor = a;
h._updateCurrentRegions = function() {
...
h.rendering = function(i, n, o) {
var r = i || cc._renderContext, s = r.getContext();
r.setTransform(this._worldTransform, n, o);
s.save();
s.scale(1, -1);
var c = this.style;
s.strokeStyle = c.strokeStyle;
s.fillStyle = c.fillStyle;
s.lineWidth = c.lineWidth;
s.lineJoin = c.lineJoin;
s.miterLimit = c.miterLimit;
for (var a = !0, h = this.cmds, l = 0, u = h.length; l < u; l++) {
var d = h[l], f = d[0], p = d[1];
if ("moveTo" === f && a) {
s.beginPath();
a = !1;
} else "fill" !== f && "stroke" !== f && "fillRect" !== f || (a = !0);
"function" === ("object" == (e = typeof s[f]) ? t(s[f]) : e) ? s[f].apply(s, p) : s[f] = p;
}
s.restore();
};
h.setStrokeColor = function(t) {
var e = "rgba(" + (0 | t.r) + "," + (0 | t.g) + "," + (0 | t.b) + "," + t.a / 255 + ")";
this.cmds.push([ "strokeStyle", e ]);
this.style.strokeStyle = e;
};
h.setFillColor = function(t) {
var e = "rgba(" + (0 | t.r) + "," + (0 | t.g) + "," + (0 | t.b) + "," + t.a / 255 + ")";
...
var e = "butt";
t === r.BUTT ? e = "butt" : t === r.ROUND ? e = "round" : t === r.SQUARE && (e = "square");
...
h.bezierCurveTo = function(t, e, i, n, o, r) {
this.cmds.push([ "bezierCurveTo", [ t, e, i, n, o, r ] ]);
};
h.quadraticCurveTo = function(t, e, i, n) {
this.cmds.push([ "quadraticCurveTo", [ t, e, i, n ] ]);
};
h.arc = function(t, e, i, n, o, r) {
c.arc(this, t, e, i, n, o, r);
};
h.ellipse = function(t, e, i, n) {
c.ellipse(this, t, e, i, n);
};
h.circle = function(t, e, i) {
c.ellipse(this, t, e, i, i);
};
h.rect = function(t, e, i, n) {
this.moveTo(t, e);
this.lineTo(t + i, e);
this.lineTo(t + i, e + n);
this.lineTo(t, e + n);
...
h.roundRect = function(t, e, i, n, o) {
c.roundRect(this, t, e, i, n, o);
};
h.fillRect = function(t, e, i, n) {
...
89: [ (function(t, e, i) {
var n = t("./graphics-canvas-cmd"), o = t("./graphics-webgl-cmd"), r = t("./types").LineCap, s = t("./types").LineJoin, c = (cc.js, 
_ccsg.Node.extend({
ctor: function() {
this._super();
...
return cc._renderType === cc.game.RENDER_TYPE_CANVAS ? new n(this) : new o(this);
}
})), a = c.prototype;
a._strokeColor = null;
a._fillColor = null;
...
this._strokeColor = t;
this._renderCmd.setStrokeColor(t);
};
...
this._fillColor = t;
this._renderCmd.setFillColor(t);
};
...
this._lineWidth = t;
this._renderCmd.setLineWidth(t);
};
...
this._lineCap = t;
this._renderCmd.setLineCap(t);
};
a.getLineCap = function() {
return this._lineCap;
};
a.setLineJoin = function(t) {
this._lineJoin = t;
this._renderCmd.setLineJoin(t);
};
a.getLineJoin = function() {
return this._lineJoin;
};
a.setMiterLimit = function(t) {
this._miterLimit = t;
this._renderCmd.setMiterLimit(t);
};
a.getMiterLimit = function() {
...
a.bezierCurveTo = function(t, e, i, n, o, r) {
this._renderCmd.bezierCurveTo(t, e, i, n, o, r);
};
a.quadraticCurveTo = function(t, e, i, n) {
this._renderCmd.quadraticCurveTo(t, e, i, n);
};
a.arc = function(t, e, i, n, o, r) {
this._renderCmd.arc(t, e, i, n, o, r);
};
...
a.roundRect = function(t, e, i, n, o) {
this._renderCmd.roundRect(t, e, i, n, o);
};
...
e.initWithVertexShaderByteArray(cc.PresetShaders.POSITION_COLOR_VERT, cc.PresetShaders.POSITION_COLOR_FRAG);
e.retain();
...
var a = t("./types").LineCap, h = t("./types").LineJoin, l = t("./earcut"), u = t("./helper"), d = cc.Vec2, f = cc.js, p = 32, _ = Math.PI, g = Math.min, v = Math.max, y = Math.ceil, m = Math.acos, b = Math.cos, C = Math.sin, T = Math.atan2, E = Math.abs, S = cc.Enum({
PT_CORNER: 1,
PT_LEFT: 2,
PT_BEVEL: 4,
PT_INNERBEVEL: 8
...
s.prototype.alloc = function(t, e) {
var i = this.vertsOffset + t;
if (i > 65535) return !1;
var n = this.vertsBuffer, o = n ? n.length / 3 : 0;
if (i > o) {
0 === o && (o = p);
for (;i > o; ) o *= 2;
var r = new Float32Array(3 * o), s = new Uint32Array(r.buffer);
if (n) for (var c = this.uint32VertsBuffer, a = 0, h = n.length; a < h; a += 3) {
r[a] = n[a];
r[a + 1] = n[a + 1];
s[a + 2] = c[a + 2];
}
this.vertsBuffer = r;
this.uint32VertsBuffer = s;
}
var l = this.indicesBuffer, u = this.indicesOffset + e, d = l ? l.length : 0;
if (u > d) {
0 === d && (d = 3 * p);
for (;u > d; ) d *= 2;
var f = new Uint16Array(d);
if (l) for (var a = 0, h = l.length; a < h; a++) f[a] = l[a];
this.indicesBuffer = f;
}
return !0;
};
(c.prototype = Object.create(_ccsg.Node.WebGLRenderCmd.prototype)).constructor = c;
var x = c.prototype;
x._tessTol = .25;
x._distTol = .01;
x.lineWidth = 1;
...
x.lineTo = function(t, e) {
this._addPoint(t, e, S.PT_CORNER);
this._commandx = t;
this._commandy = e;
};
x.bezierCurveTo = function(t, e, i, n, o, r) {
var s = this._curPath, c = s.points[s.points.length - 1];
if (c.x !== t || c.y !== e || i !== o || n !== r) {
this._tesselateBezier(c.x, c.y, t, e, i, n, o, r, 0, S.PT_CORNER);
this._commandx = o;
this._commandy = r;
} else this.lineTo(o, r);
};
x.quadraticCurveTo = function(t, e, i, n) {
var o = this._commandx, r = this._commandy;
this.bezierCurveTo(o + 2 / 3 * (t - o), r + 2 / 3 * (e - r), i + 2 / 3 * (t - i), n + 2 / 3 * (e - n), i, n);
};
x.arc = function(t, e, i, n, o, r) {
u.arc(this, t, e, i, n, o, r);
};
x.ellipse = function(t, e, i, n) {
u.ellipse(this, t, e, i, n);
this._curPath.complex = !1;
};
x.circle = function(t, e, i) {
u.ellipse(this, t, e, i, i);
this._curPath.complex = !1;
};
x.rect = function(t, e, i, n) {
this.moveTo(t, e);
this.lineTo(t, e + n);
this.lineTo(t + i, e + n);
this.lineTo(t + i, e);
...
x.roundRect = function(t, e, i, n, o) {
u.roundRect(this, t, e, i, n, o);
this._curPath.complex = !1;
};
x.fillRect = function(t, e, i, n) {
this.rect(t, e, i, n);
this.fill();
};
x.close = function() {
...
x._strokeColor = null;
x._fillColor = null;
x.setStrokeColor = function(t) {
this._strokeColor = t;
};
x.getStrokeColor = function() {
return this._strokeColor;
};
x.setFillColor = function(t) {
this._fillColor = t;
};
x.getFillColor = function() {
return this._fillColor;
};
x.setLineWidth = function(t) {
this.lineWidth = t;
};
x.setLineJoin = function(t) {
this.lineJoin = t;
};
x.setLineCap = function(t) {
this.lineCap = t;
};
x.setMiterLimit = function(t) {
this.miterLimit = t;
};
f.getset(x, "strokeColor", x.getStrokeColor, x.setStrokeColor);
f.getset(x, "fillColor", x.getFillColor, x.setFillColor);
x._render = function() {
var t = this._buffers;
if (0 !== t.length) for (var e = cc._renderContext, i = 0, n = t.length; i < n; i++) {
var o = t[i];
e.bindBuffer(e.ARRAY_BUFFER, o.vertsVBO);
e.bindBuffer(e.ELEMENT_ARRAY_BUFFER, o.indicesVBO);
if (o.vertsDirty) {
e.bufferData(e.ARRAY_BUFFER, o.vertsBuffer, e.STREAM_DRAW);
o.vertsDirty = !1;
}
if (o.indicesDirty && o.indicesBuffer) {
e.bufferData(e.ELEMENT_ARRAY_BUFFER, o.indicesBuffer, e.STREAM_DRAW);
o.indicesDirty = !1;
}
...
e.drawElements(e.TRIANGLES, o.indicesOffset, e.UNSIGNED_SHORT, 0);
cc.g_NumberOfDraws++;
}
};
x.rendering = function() {
cc.gl.blendFunc(this._blendFunc.src, this._blendFunc.dst);
var t = this._worldTransform, e = this._matrix.mat;
e[0] = t.a;
e[4] = t.c;
e[12] = t.tx;
e[1] = t.b;
...
i.use();
i._setUniformForMVPMatrixWithMat4(this._matrix);
this._render();
};
x.clear = function(t) {
this._pathLength = 0;
...
x._addPoint = function(t, e, i) {
var n = this._curPath;
if (n) {
var r, s = this._points, c = n.points;
...
x._flattenPaths = function() {
for (var t = this._paths, e = this._pathOffset, i = this._pathLength; e < i; e++) {
var n = t[e], o = n.points, r = o[o.length - 1], s = o[0];
if (r.equals(s)) {
n.closed = !0;
o.pop();
r = o[o.length - 1];
...
x._allocBuffer = function() {
if (this._buffer) {
var t = this._buffers.indexOf(this._buffer);
if (t < this._buffers.length - 1) {
this._buffer = this._buffers[t + 1];
return;
}
}
var e = new s();
...
x._allocVerts = function(t) {
this._buffer || this._allocBuffer();
var e = 3 * (t - 2 * (this._pathLength - this._pathOffset));
if (!this._buffer.alloc(t, e)) {
this._allocBuffer();
this._buffer.alloc(t, e);
}
this._buffer.vertsDirty = !0;
};
x._expandStroke = function() {
var t = .5 * this.lineWidth, e = this.lineCap, i = this.lineJoin, n = this.miterLimit, o = this._curveDivs(t, _, this._tessTol), r = this._paths;
this._calculateJoins(t, i, n);
for (var s = 0, c = this._pathOffset, l = this._pathLength; c < l; c++) {
b = (y = r[c]).points.length;
i === h.ROUND ? s += 2 * (b + y.nbevel * (o + 2) + 1) : s += 2 * (b + 5 * y.nbevel + 1);
y.closed || (e === a.ROUND ? s += 2 * (2 * o + 2) : s += 12);
}
this._allocVerts(s);
for (var u = this._buffer, c = this._pathOffset, l = this._pathLength; c < l; c++) {
var d, f, p, g, v, y = r[c], m = y.points, b = y.points.length;
v = y.closed;
var C = u.vertsOffset;
if (v) {
d = m[b - 1];
...
if (!v) {
(w = f.sub(d)).normalizeSelf();
var T = w.x, E = w.y;
e === a.BUTT ? this._buttCap(d, T, E, t, 0) : e === a.SQUARE ? this._buttCap(d, T, E, t, t) : e === a.ROUND && this._roundCapStart(d, T, E, t, o);
}
for (var x = p; x < g; ++x) {
if (i === h.ROUND) this._roundJoin(d, f, t, t, o); else if (0 != (f.flags & (S.PT_BEVEL | S.PT_INNERBEVEL))) this._bevelJoin(d, f, t, t); else {
this._vset(f.x + f.dmx * t, f.y + f.dmy * t);
this._vset(f.x - f.dmx * t, f.y - f.dmy * t);
}
d = f;
f = m[x + 1];
...
if (v) {
var A = u.vertsBuffer;
this._vset(A[3 * C], A[3 * C + 1]);
this._vset(A[3 * (C + 1)], A[3 * (C + 1) + 1]);
} else {
var w = f.sub(d);
w.normalizeSelf();
var T = w.x, E = w.y;
e === a.BUTT ? this._buttCap(f, T, E, t, 0) : e === a.BUTT || e === a.SQUARE ? this._buttCap(f, T, E, t, t) : e === a.ROUND && this._roundCapEnd(f, T, E, t, o);
}
for (var O = u.indicesOffset, I = u.indicesBuffer, N = C + 2, L = u.vertsOffset; N < L; N++) {
I[O++] = N - 2;
I[O++] = N - 1;
I[O++] = N;
}
...
x._expandFill = function() {
for (var t = this._paths, e = 0, i = this._pathOffset, n = this._pathLength; i < n; i++) e += c = (r = t[i]).points.length;
this._allocVerts(e);
for (var o = this._buffer, i = this._pathOffset, n = this._pathLength; i < n; i++) {
var r = t[i], s = r.points, c = s.length;
if (0 !== c) {
for (var a = o.vertsOffset, h = 0; h < c; ++h) this._vset(s[h].x, s[h].y, .5, 1);
var u = r.indicesOffset = o.indicesOffset, d = o.indicesBuffer, f = 0;
if (r.complex) {
for (var p = [], _ = 3 * a, g = 3 * o.vertsOffset, h = _; h < g; h += 3) {
p.push(o.vertsBuffer[h]);
p.push(o.vertsBuffer[h + 1]);
}
var v = l(p, null, 2);
if (!v || 0 === v.length) continue;
for (var h = 0, y = f = v.length; h < y; h++) d[u + h] = v[h] + a;
} else {
for (var m = a, _ = a + 2, g = o.vertsOffset; _ < g; _++) {
d[u++] = m;
d[u++] = _ - 1;
d[u++] = _;
}
...
x._curveDivs = function(t, e, i) {
var n = 2 * m(t / (t + i));
return v(2, y(e / n));
};
x._calculateJoins = function(t, e, i) {
var n = 0;
t > 0 && (n = 1 / t);
for (var o = this._paths, r = this._pathOffset, s = this._pathLength; r < s; r++) {
var c = o[r], a = c.points, l = a.length, u = a[l - 1], d = a[0];
c.nbevel = 0;
for (var f = 0; f < l; f++) {
var p, _, y = u.dy, m = -u.dx, b = d.dy, C = -d.dx;
d.dmx = .5 * (y + b);
d.dmy = .5 * (m + C);
if ((p = d.dmx * d.dmx + d.dmy * d.dmy) > 1e-6) {
var T = 1 / p;
T > 600 && (T = 600);
d.dmx *= T;
d.dmy *= T;
}
if (d.dx * u.dy - u.dx * d.dy > 0) {
0;
d.flags |= S.PT_LEFT;
}
p * (_ = v(11, g(u.len, d.len) * n)) * _ < 1 && (d.flags |= S.PT_INNERBEVEL);
d.flags & S.PT_CORNER && (p * i * i < 1 || e === h.BEVEL || e === h.ROUND) && (d.flags |= S.PT_BEVEL);
0 != (d.flags & (S.PT_BEVEL | S.PT_INNERBEVEL)) && c.nbevel++;
u = d;
d = a[f + 1];
}
}
};
x._vset = function(t, e) {
var i = this._buffer, n = 3 * i.vertsOffset, o = i.vertsBuffer;
o[n] = t;
o[n + 1] = e;
i.uint32VertsBuffer[n + 2] = this._curColorValue;
i.vertsOffset++;
};
x._chooseBevel = function(t, e, i, n) {
var o, r, s, c, a = i.x, h = i.y;
if (0 !== t) {
o = a + e.dy * n;
r = h - e.dx * n;
s = a + i.dy * n;
...
x._buttCap = function(t, e, i, n, o) {
var r = t.x - e * o, s = t.y - i * o, c = i, a = -e;
this._vset(r + c * n, s + a * n);
this._vset(r - c * n, s - a * n);
};
x._roundCapStart = function(t, e, i, n, o) {
for (var r = t.x, s = t.y, c = i, a = -e, h = 0; h < o; h++) {
var l = h / (o - 1) * _, u = b(l) * n, d = C(l) * n;
this._vset(r - c * u - e * d, s - a * u - i * d);
this._vset(r, s);
}
this._vset(r + c * n, s + a * n);
this._vset(r - c * n, s - a * n);
};
x._roundCapEnd = function(t, e, i, n, o) {
var r = t.x, s = t.y, c = i, a = -e;
this._vset(r + c * n, s + a * n);
this._vset(r - c * n, s - a * n);
for (var h = 0; h < o; h++) {
var l = h / (o - 1) * _, u = b(l) * n, d = C(l) * n;
...
x._roundJoin = function(t, e, i, o, r) {
var s = t.dy, c = -t.dx, a = e.dy, h = -e.dx, l = e.x, u = e.y;
if (0 != (e.flags & S.PT_LEFT)) {
var d = (w = this._chooseBevel(e.flags & S.PT_INNERBEVEL, t, e, i))[0], f = w[1], p = w[2], g = w[3], v = T(-c, -s);
(R = T(-h, -a)) > v && (R -= 2 * _);
this._vset(d, f);
this._vset(l - s * o, e.y - c * o);
for (var m = n(y((v - R) / _) * r, 2, r), E = 0; E < m; E++) {
var x = l + b(B = v + (P = E / (m - 1)) * (R - v)) * o, A = u + C(B) * o;
this._vset(l, u);
this._vset(x, A);
}
this._vset(p, g);
this._vset(l - a * o, u - h * o);
} else {
var w = this._chooseBevel(e.flags & S.PT_INNERBEVEL, t, e, -o), O = w[0], I = w[1], N = w[2], L = w[3], v = T(c, s), R = T(h, a);
R < v && (R += 2 * _);
this._vset(l + s * o, u + c * o);
this._vset(O, I);
for (var m = n(y((R - v) / _) * r, 2, r), E = 0; E < m; E++) {
var P = E / (m - 1), B = v + P * (R - v), D = l + b(B) * i, M = u + C(B) * i;
this._vset(D, M);
this._vset(l, u);
}
this._vset(l + a * o, u + h * o);
...
x._bevelJoin = function(t, e, i, n) {
var o, r, s, c, a, h, l, u, d = t.dy, f = -t.dx, p = e.dy, _ = -e.dx;
if (e.flags & S.PT_LEFT) {
a = (g = this._chooseBevel(e.flags & S.PT_INNERBEVEL, t, e, i))[0];
h = g[1];
l = g[2];
u = g[3];
this._vset(a, h);
this._vset(e.x - d * n, e.y - f * n);
this._vset(l, u);
this._vset(e.x - p * n, e.y - _ * n);
} else {
var g = this._chooseBevel(e.flags & S.PT_INNERBEVEL, t, e, -n);
o = g[0];
r = g[1];
s = g[2];
c = g[3];
this._vset(e.x + d * i, e.y + f * i);
this._vset(o, r);
this._vset(e.x + p * i, e.y + _ * i);
this._vset(s, c);
}
};
x._tesselateBezier = function(t, e, i, n, o, r, s, c, a, h) {
var l, u, d, f, p, _, g, v, y, m, b, C, T, x, A, w;
if (!(a > 10)) {
p = .5 * (o + s);
_ = .5 * (r + c);
g = .5 * ((l = .5 * (t + i)) + (d = .5 * (i + o)));
v = .5 * ((u = .5 * (e + n)) + (f = .5 * (n + r)));
if (((A = E((i - s) * (x = c - e) - (n - c) * (T = s - t))) + (w = E((o - s) * x - (r - c) * T))) * (A + w) < this._tessTol * (T * T + x * x)) this._addPoint(s, c, 0 === h ? h | S.PT_BEVEL : h); else {
b = .5 * (g + (y = .5 * (d + p)));
C = .5 * (v + (m = .5 * (f + _)));
this._tesselateBezier(t, e, l, u, g, v, b, C, a + 1, 0);
this._tesselateBezier(b, C, y, m, p, _, s, c, a + 1, h);
}
}
};
e.exports = c;
...
92: [ (function(t, e, i) {
var n = Math.PI, o = Math.min, r = Math.max, s = Math.cos, c = Math.sin, a = Math.abs, h = Math.sign, l = .5522847493;
e.exports = {
arc: function(t, e, i, h, l, u, d) {
var f, p, _ = 0, g = 0, v = 0, y = 0, m = 0, b = 0, C = 0, T = 0, E = 0, S = 0, x = 0, A = 0, w = 0, O = 0;
g = u - l;
if (d = d || !1) if (a(g) >= 2 * n) g = 2 * n; else for (;g < 0; ) g += 2 * n; else if (a(g) >= 2 * n) g = 2 * -n; else for (;g > 0; ) g -= 2 * n;
p = 0 | r(1, o(a(g) / (.5 * n) + .5, 5));
y = a(4 / 3 * (1 - s(v = g / p / 2)) / c(v));
d || (y = -y);
for (f = 0; f <= p; f++) {
C = e + (m = s(_ = l + g * (f / p))) * h;
T = i + (b = c(_)) * h;
E = -b * h * y;
S = m * h * y;
0 === f ? t.moveTo(C, T) : t.bezierCurveTo(x + w, A + O, C - E, T - S, C, T);
x = C;
A = T;
w = E;
O = S;
...
t.moveTo(e - n, i);
t.bezierCurveTo(e - n, i + o * l, e - n * l, i + o, e, i + o);
t.bezierCurveTo(e + n * l, i + o, e + n, i + o * l, e + n, i);
t.bezierCurveTo(e + n, i - o * l, e + n * l, i - o, e, i - o);
t.bezierCurveTo(e - n * l, i - o, e - n, i - o * l, e - n, i);
t.close();
},
roundRect: function(t, e, i, n, r, s) {
if (s < .1) t.rect(e, i, n, r); else {
var c = o(s, .5 * a(n)) * h(n), u = o(s, .5 * a(r)) * h(r);
t.moveTo(e, i + u);
t.lineTo(e, i + r - u);
t.bezierCurveTo(e, i + r - u * (1 - l), e + c * (1 - l), i + r, e + c, i + r);
t.lineTo(e + n - c, i + r);
t.bezierCurveTo(e + n - c * (1 - l), i + r, e + n, i + r - u * (1 - l), e + n, i + r - u);
t.lineTo(e + n, i + u);
t.bezierCurveTo(e + n, i + u * (1 - l), e + n - c * (1 - l), i, e + n - c, i);
t.lineTo(e + c, i);
t.bezierCurveTo(e + c * (1 - l), i, e, i + u * (1 - l), e, i + u);
t.close();
}
}
};
...
"use strict";
var n;
(n = cc.sys.isNative ? _ccsg.GraphicsNode = cc.GraphicsNode : _ccsg.GraphicsNode = t("./graphics-node")) && t("../utils/misc").propertyDefine(n, [ "lineWidth", "lineCap", "lineJoin", "miterLimit", "strokeColor", "fillColor" ], {});
t("./graphics");
}), {
"../utils/misc": 162,
"./graphics": 91,
...
var e = /[\u3000-\u303F]|[\u3040-\u309F]|[\u30A0-\u30FF]|[\uFF00-\uFFEF]|[\u4E00-\u9FAF]|[\u2605-\u2606]|[\u2190-\u2195]|\u203B/g, i = /^[\u1100-\u11FF]|[\u3130-\u318F]|[\uA960-\uA97F]|[\uAC00-\uD7AF]|[\uD7B0-\uD7FF]+$/;
return /^[\u4E00-\u9FFF\u3400-\u4DFF]+$/.test(t) || e.test(t) || i.test(t);
},
...
if (this.label_firsrEnglish.test(h) && (f = this.label_lastEnglish.exec(p)) && p !== f[0]) {
s -= f[0].length;
h = r.substr(s);
p = r.substr(0, s);
}
p.trim().length > 0 && o.push(p);
e = n(r = h || c);
}
r.length > 0 && o.push(r);
return o;
...
s.getAllPaths = function() {
return Object.keys(this._pathToUuid);
};
s.add = function(t, e, i, o) {
t = t.substring(0, t.length - cc.path.extname(t).length);
var r = new n(e, i), s = this._pathToUuid, c = s[t];
c ? Array.isArray(c) ? o ? c.unshift(r) : c.push(r) : s[t] = o ? [ r, c ] : [ c, r ] : s[t] = r;
};
s.reset = function() {
this._pathToUuid = {};
};
...
var s, c = t("../platform/js"), a = t("../utils/CCPath"), h = t("../utils/misc"), l = t("./pipeline"), u = t("./pack-downloader"), d = t("./text-downloader"), f = t("./utils").urlAppendTimestamp, p = {
...
c.removeEventListener("load", n, !1);
c.removeEventListener("error", o, !1);
e(null, r);
}
function o() {
c.parentNode.removeChild(c);
c.removeEventListener("load", n, !1);
c.removeEventListener("error", o, !1);
e(new Error("Load " + r + " failed!"), r);
}
var r = t.url, s = document, c = document.createElement("script");
c.async = i;
c.src = f(r);
c.addEventListener("load", n, !1);
c.addEventListener("error", o, !1);
...
default: d
}, g = "Downloader", v = function(t) {
this.id = g;
this.async = !0;
this.pipeline = null;
this._curConcurrent = 0;
this._loadQueue = [];
this.extMap = c.mixin(t, _);
};
v.ID = g;
...
l.Downloader = e.exports = v;
}), {
"../platform/js": 151,
"../utils/CCPath": 157,
"../utils/misc": 162,
"./audio-downloader": 218,
"./pack-downloader": 108,
"./pipeline": 109,
"./text-downloader": 110,
"./utils": 111
...
function s(t, e) {
if (!(t.content instanceof Image)) return new Error("Image Loader: Input item doesn't contain Image content");
var i = t.rawUrl, n = cc.textureCache.getTextureForKey(i) || new h();
n.url = i;
n.initWithElement(t.content);
n.handleLoadedTexture();
cc._renderType === cc.game.RENDER_TYPE_WEBGL && u.imagePool.put(t.content);
cc.textureCache.cacheImage(i, n);
return n;
}
var c = i("../platform/js"), a = i("./pipeline"), h = i("../textures/CCTexture2D"), l = i("./uuid-loader"), u = i("../utils/misc"), d = {
png: s,
jpg: s,
bmp: s,
jpeg: s,
...
if ("object" === ("object" == (e = typeof i) ? t(i) : e)) {
u.mixin(r, i);
if (i.skips) for (var c = 0; c < i.skips.length; c++) {
var a = i.skips[c];
r.states[a] = _.COMPLETE;
}
}
r.rawUrl = r.url;
...
if (!(v.indexOf(r.id) >= 0) && (r.deps && a(t, r, !0))) {
n = !0;
break;
}
}
...
var h = i("../platform/callbacks-invoker"), l = i("../utils/CCPath"), u = i("../platform/js"), d = 0 | 998 * Math.random(), f = {}, p = [], _ = {
WORKING: 1,
COMPLETE: 2,
ERROR: 3
}, g = {}, v = [], y = function(t, e, i, n) {
h.call(this);
this._id = ++d;
f[this._id] = this;
this._pipeline = t;
...
if (!i) return !1;
var n = g[i];
if (n) -1 === n.deps.indexOf(e) && n.deps.push(e); else if (t.id) for (var o in g) {
var r = g[o];
...
if (r(n)) {
var h = (o = c(n, this._id)).id;
if (!this.map[h]) {
this.map[h] = o;
this.totalCount++;
e && e.deps.push(o);
y.registerQueueDep(e || this._id, h);
s.push(o);
}
}
} else {
...
m.addListener = h.prototype.add;
m.hasListener = h.prototype.has;
m.removeListener = h.prototype.remove;
m.removeAllListeners = h.prototype.removeAll;
...
f[this._id] = null;
if (g[this._id]) {
g[this._id].completed.length = 0;
g[this._id].deps.length = 0;
}
-1 === p.indexOf(this) && p.length < 10 && p.push(this);
};
...
var o = i[n], c = r[o];
if (c) {
Array.isArray(c) ? c.push(e) : r[o] = c = [ c, e ];
if (1 === i.length) {
var a = c[0];
c[0] = c[c.length - 1];
c[c.length - 1] = a;
...
var h = c[s];
if (h && h.state === a.Loaded) {
var l = h.retrieve(i);
return l || n(i, s);
}
if (!h) {
console.log("Create unpacker %s for %s", s, i);
(h = c[s] = new o()).state = a.Downloading;
}
...
var s, c, a, h, u, d = n.uuidList, f = e.dependKeys = [];
if (o) {
s = [];
c = [];
a = [];
...
u = d[h];
var p = n.uuidObjList[h], _ = n.uuidPropList[h], g = cc.AssetLibrary._getAssetInfoInRuntime(u);
if (g.raw) {
var v = g.url;
p[_] = v;
f.push(v);
...
var m = l.getQueue(o), b = m._callbackTable[d];
...
var e = h._getClassById(t);
if (e) return e;
cc.warnID(4903, t);
return Object;
};
var u, d = cc.deserialize.Details.pool.get();
try {
u = cc.deserialize(o, d, {
classFinder: a,
...
u._uuid = i.uuid;
var p = c(u, i, l);
s(this.pipeline, i, u, d, p, n);
}
var h = i("../platform/js");
i("../platform/deserialize");
var l = i("./loading-items");
n.exports = a;
a.isSceneObj = r;
}), {
...
var c = i("./component-scheduler"), a = i("./platform/CCObject").Flags, h = i("./platform/js"), l = a.IsPreloadStarted, u = a.IsOnLoadStarted, d = a.IsOnLoadCalled, f = a.Deactivating, p = cc.Class({
...
}), _ = c.createInvokeImpl("c.__preload();"), g = c.createInvokeImpl("c.onLoad();c._objFlags|=" + d), v = new h.Pool(4);
v.get = function() {
var t = this._get() || {
preload: new p(_),
onLoad: new c.OneOffInvoker(g),
...
function o() {}
var r = t("./CCPhysicsTypes").PTM_RATIO, s = t("./CCPhysicsTypes").ContactType, c = [], a = [ cc.v2(), cc.v2() ], h = {
points: [],
separations: [],
normal: cc.v2()
}, l = [ new n(), new n() ], u = {
...
for (var t, e = u.points, i = u.localNormal, n = u.localPoint, o = cc.PhysicsUtils.getContactManifoldWrapper(), r = e.length = o.getCount(), s = 0; s < r; s++) {
(t = l[s]).localPoint.x = o.getX(s);
t.localPoint.y = o.getX(s);
t.normalImpulse = o.getNormalImpulse(s);
t.tangentImpulse = o.getTangentImpulse(s);
e[s] = t;
}
i.x = o.getLocalNormalX();
i.y = o.getLocalNormalY();
n.x = o.getLocalPointX();
n.y = o.getLocalPointY();
u.type = o.getType();
if (this._inverted) {
i.x *= -1;
i.y *= -1;
...
function c(t) {
_(t);
for (var e, i, n, o, g, v, m = [], b = cc.v2(), C = cc.v2(), T = 0, E = 0, S = 0; S < t.length; ++S) if (h(S, t)) {
i = n = 1e8;
for (O = 0; O < t.length; ++O) {
if (u(r(S - 1, t), r(S, t), r(O, t)) && f(r(S - 1, t), r(S, t), r(O - 1, t))) {
o = y(r(S - 1, t), r(S, t), r(O, t), r(O - 1, t));
if (l(r(S + 1, t), r(S, t), o) && (e = p(r(S, t), o)) < i) {
i = e;
b = o;
T = O;
}
}
if (u(r(S + 1, t), r(S, t), r(O + 1, t)) && f(r(S + 1, t), r(S, t), r(O, t))) {
o = y(r(S + 1, t), r(S, t), r(O, t), r(O + 1, t));
if (u(r(S - 1, t), r(S, t), o) && (e = p(r(S, t), o)) < n) {
n = e;
E = O;
C = o;
}
...
for (var A = 0, w = T; E < T; ) E += t.length;
for (var O = T; O <= E; ++O) if (a(S, O, t)) {
var I = 1 / (p(r(S, t), r(O, t)) + 1);
h(O, t) ? f(r(O - 1, t), r(O, t), r(S, t)) && d(r(O + 1, t), r(O, t), r(S, t)) ? I += 3 : I += 2 : I += 1;
if (I > A) {
w = O;
A = I;
}
...
return m = (m = m.concat(c(g))).concat(c(v));
}
m.push(t);
for (S = m.length - 1; S >= 0; S--) 0 == m[S].length && m.splice(S, 0);
return m;
}
function a(t, e, i) {
if (h(t, i)) {
if (d(r(t, i), r(t - 1, i), r(e, i)) && f(r(t, i), r(t + 1, i), r(e, i))) return !1;
} else if (f(r(t, i), r(t + 1, i), r(e, i)) || d(r(t, i), r(t - 1, i), r(e, i))) return !1;
if (h(e, i)) {
if (d(r(e, i), r(e - 1, i), r(t, i)) && f(r(e, i), r(e + 1, i), r(t, i))) return !1;
} else if (f(r(e, i), r(e + 1, i), r(t, i)) || d(r(e, i), r(e - 1, i), r(t, i))) return !1;
for (var n = 0; n < i.length; ++n) if ((n + 1) % i.length != t && n != t && (n + 1) % i.length != e && n != e) {
var o = cc.v2();
if (m(r(t, i), r(e, i), r(n, i), r(n + 1, i), o)) return !1;
}
return !0;
}
function h(t, e) {
...
"./platform/CCPhysicsAABBQueryCallback": 218,
"./platform/CCPhysicsContactListner": 218,
"./platform/CCPhysicsDebugDraw": 218,
"./platform/CCPhysicsRayCastCallback": 218,
"./platform/CCPhysicsUtils": 218
} ],
125: [ (function(t, e, i) {
var n = t("../CCPhysicsTypes").PTM_RATIO, o = cc.Class({
...
var r = n.default;
x.setClassAttr(t, i, "default", r);
s(t, i);
var c = C(t, n, e, i, !1);
if (c) {
for (var a = L, h = 0; h < c.length; h++) {
var l = c[h];
x.attr(t, i, l);
...
if (r) {
for (var l = C(t, n, e, i, !0), u = 0; u < l.length; u++) x.attr(t, i, l[u]);
l.length = 0;
x.setClassAttr(t, i, "serializable", !1);
o || T.get(c, i, r, h, h);
}
s && (o || T.set(c, i, s, h, h));
}
...
function l(t, e, i) {
for (var n in e) t.hasOwnProperty(n) || i && !i(n) || Object.defineProperty(t, n, T.getPropertyDescriptor(e, n));
}
function u(t, e, i, n) {
var o, r, s = n.__ctor__, c = n.ctor, a = n.__ES6__;
if (a) {
o = [ c ];
r = c;
} else {
r = g(o = s ? [ s ] : v(e, i, n), e, t, n);
T.value(r, "extend", (function(t) {
t.extends = this;
return b(t);
}), !0);
}
T.value(r, "__ctors__", o.length > 0 ? o : null, !0);
var h = r.prototype;
if (e) {
if (!a) {
T.extend(r, e);
...
b._isCCClass(d) && l(x.getClassAttrs(r).constructor.prototype, x.getClassAttrs(d).constructor.prototype);
}
h.constructor = r;
}
a || (h.__initProps__ = _);
...
function f(i) {
var n, o = T.getClassName(i), r = i.constructor, s = "new " + o + "(";
if (r === cc.Mat3 || r === cc.Mat4) {
var c = i.data;
for (n = 0; n < c.length; n++) {
s += c[n];
n < c.length - 1 && (s += ",");
}
} else for (n = 0; n < r.__props__.length; n++) {
var a = i[r.__props__[n]];
if ("object" === ("object" == (e = typeof a) ? t(a) : e)) {
cc.errorID(3641, o);
return "new " + o + "()";
}
s += a;
n < r.__props__.length - 1 && (s += ",");
}
return s + ")";
}
function p(t) {
...
function _(i) {
var n = x.getClassAttrs(i), o = i.__props__;
if (null === o) {
N.init();
o = i.__props__;
}
for (var r = [], s = "", c = 0; c < o.length; c++) {
var a = o[c], h = a + A + "default";
if (h in n) {
var l;
l = R.test(a) ? "this." + a + "=" : "this[" + p(a) + "]=";
var u, d = n[h];
if ("object" === ("object" == (e = typeof d) ? t(d) : e) && d) u = d instanceof cc.ValueType ? f(d) : Array.isArray(d) ? "[]" : "{}"; else if ("function" === ("object" == (e = typeof d) ? t(d) : e)) {
var _ = r.length;
r.push(d);
u = "F[" + _ + "]()";
} else u = "string" === ("object" == (e = typeof d) ? t(d) : e) ? p(d) : d;
s += l = l + u + ";\n";
}
}
var g;
g = 0 === r.length ? Function(s) : Function("F", "return (function(){\n" + s + "})")(r);
i.prototype.__initProps__ = g;
g.call(this);
}
function g(t, e, i, n) {
...
function v(t, e, i) {
for (var n = [], o = [ t ].concat(e), s = 0; s < o.length; s++) {
var c = o[s];
if (c) for (var a = (function(t) {
return b._isCCClass(t) ? t.__ctors__ || [] : [ t ];
})(c), h = 0; h < a.length; h++) r(n, a[h]);
}
var l = i.ctor;
l && n.push(l);
return n;
...
function y(i, n, o) {
var r = !1;
for (var s in n) if (!(I.indexOf(s) >= 0)) {
var c = n[s];
if ("function" === ("object" == (e = typeof c) ? t(c) : e)) {
var a = T.getPropertyDescriptor(i.prototype, s);
if (a) {
var h = a.value;
...
for (var l in i) {
var u = i[l];
"default" in u ? c(t, e, l, u, r) : a(t, e, l, u, r);
}
}
}
function b(i) {
var n = (i = i || {}).name, o = i.extends, r = i.mixins, s = d(n, o, r, i);
...
s.__props__ = null;
} else m(s, n, c, o, i.mixins, i.__ES6__);
var a = i.statics;
if (a) {
var h;
for (h in a) s[h] = a[h];
}
for (var l in i) if (!(I.indexOf(l) >= 0)) {
var u = i[l];
O.validateMethodWithProps(u, l, n, s, o) && T.value(s.prototype, l, u, !0, !0);
}
var f = i.editor;
f && cc.isChildClassOf(o, cc.Component) && cc.Component._registerEditorProps(s, f);
return s;
}
function C(i, n, o, r, s) {
function c() {
l = r + A;
return h = x.getClassAttrsProto(i);
}
function a(i, o) {
if (i in n) {
var r = n[i];
...
if (f) u.push({
type: d,
_onAfterProp: w(f, "cc." + d)
}); else if ("Object" === d) ; else if (d === x.ScriptUuid) {
var p = x.ObjectType(cc.ScriptAsset);
p.type = "Script";
u.push(p);
} else "object" === ("object" == (e = typeof d) ? t(d) : e) ? E.isEnum(d) && u.push({
type: "Enum",
enumList: E.getList(d)
}) : "function" === ("object" == (e = typeof d) ? t(d) : e) && (n.url ? u.push({
type: "Object",
ctor: d,
_onAfterProp: w("String", "cc.String")
}) : u.push(n._short ? {
type: "Object",
ctor: d
} : x.ObjectType(d)));
...
var T = i("./js"), E = i("./CCEnum"), S = i("./utils"), x = (S.isPlainEmptyObj_DEV, 
S.cloneable_DEV, i("./attribute")), A = x.DELIMETER, w = x.getTypeChecker, O = i("./preprocess-class");
i("./requiring-frame");
var I = [ "name", "extends", "mixins", "ctor", "__ctor__", "properties", "statics", "editor", "__ES6__" ], N = {
datas: null,
push: function(t) {
...
var c = T.getClassName(r);
s ? m(r, c, s, r.$super, o.mixins) : cc.errorID(3633, c);
}
this.datas = null;
}
}
}, L = [], R = /^[$A-Za-z_][0-9A-Za-z_$]*$/, P = /xyz/.test((function() {
xyz;
})) ? /\b\._super\b/ : /.*/;
/xyz/.test((function() {
xyz;
...
T.setClassName(t, e);
for (var n = e.__props__ = Object.keys(i), o = x.getClassAttrsProto(e), r = 0; r < n.length; r++) {
var s = n[r];
o[s + A + "visible"] = !1;
o[s + A + "default"] = i[s];
}
...
if ("function" !== ("object" == (e = typeof n) ? t(n) : e)) return !1;
if (i === n) return !0;
for (;;) {
if (!(i = T.getSuper(i))) return !1;
if (i === n) return !0;
}
}
return !1;
...
for (var e = []; t = T.getSuper(t); ) t !== Object && e.push(t);
return e;
};
var B = {
Integer: "Number",
...
var s = n && (g.getFullFormOfProperty(n) || n), c = e[i], a = v.mixin(c || {}, s || {});
if (o && (o.get || o.set)) {
o.get && (a.get = o.get);
o.set && (a.set = o.set);
} else {
...
i("./CCClass");
var g = i("./preprocess-class"), v = i("./js"), y = "__ccclassCache__", m = a.bind(null, !1), b = h(), C = h(), T = c((function(t, e) {
var i = v.getSuper(t);
i === Object && (i = null);
var n = {
name: e,
...
return cc.Class(n);
})), E = _(c), S = p(m, "requireComponent"), x = _(b), A = p(C, "executionOrder"), w = _(c), O = _(c), I = _(b), N = _(b), L = _(b);
...
t === u.length ? u.length = 0 : u.splice(0, t);
}
function c(i, n) {
var o, r = {};
...
if (cc.Class._isCCClass(n)) for (var s = cc.Class.Attr.getClassAttrs(n), c = n.__props__, a = 0; a < c.length; a++) {
var l = (o = c[a]) + cc.Class.Attr.DELIMETER + "default";
...
var f;
f = h.IDENTIFIER_RE.test(o) ? "o." + o + "=" : "o[" + h.escapeForJS(o) + "]=";
var p = r[o];
"" === p && (p = '""');
d += f + p + ";\n";
}
...
var a = i("./js"), h = i("./CCClass"), l = 1;
h.fastDefine("cc.Object", r, {
_name: "",
_objFlags: 0
});
a.value(r, "Flags", {
...
var u = [];
a.value(r, "_deferredDestroy", s);
var d = r.prototype;
a.getset(d, "name", (function() {
return this._name;
}), (function(t) {
this._name = t;
}));
a.get(d, "isValid", (function() {
...
d._destruct = function() {
var t = this.constructor, e = t.__destruct__;
if (!e) {
e = c(this, t);
a.value(t, "__destruct__", e, !0);
}
e(this);
};
d._onPreDestroy = null;
d._destroyImmediate = function() {
...
r.isNative = !1;
r.isBrowser = "object" === ("object" == (e = typeof window) ? t(window) : e) && "object" === ("object" == (e = typeof document) ? t(document) : e);
...
!(function() {
var t = /qqbrowser|chrome|safari|firefox|trident|opera|opr\/|oupeng/i, e = /mqqbrowser|micromessenger|qq|sogou|qzone|liebao|maxthon|ucbrowser|360 aphone|360browser|baiduboxapp|baidubrowser|maxthon|mxbrowser|miuibrowser/i.exec(l);
e || (e = t.exec(l));
var i = e ? e[0].toLowerCase() : r.BROWSER_TYPE_UNKNOWN;
"micromessenger" === i ? i = r.BROWSER_TYPE_WECHAT : "safari" === i && d ? i = r.BROWSER_TYPE_ANDROID : "qq" === i && l.match(/android.*applewebkit/i) ? i = r.BROWSER_TYPE_ANDROID : "trident" === i ? i = r.BROWSER_TYPE_IE : "360 aphone" === i ? i = r.BROWSER_TYPE_360 : "mxbrowser" === i ? i = r.BROWSER_TYPE_MAXTHON : "opr/" === i && (i = r.BROWSER_TYPE_OPERA);
r.browserType = i;
})();
r.browserVersion = "";
!(function() {
var t = /(mqqbrowser|micromessenger|qq|sogou|qzone|liebao|maxthon|uc|360 aphone|360|baiduboxapp|baidu|maxthon|mxbrowser|miui)(mobile)?(browser)?\/?([\d.]+)/i, e = /(qqbrowser|chrome|safari|firefox|trident|opera|opr\/|oupeng)(mobile)?(browser)?\/?([\d.]+)/i, i = l.match(t);
i || (i = l.match(e));
r.browserVersion = i ? i[4] : "";
})();
...
var A = C.toDataURL("image/webp").startsWith("data:image/webp"), w = !!C.getContext("2d"), O = !1;
if (s.WebGLRenderingContext) {
cc.create3DContext(document.createElement("CANVAS")) && (O = !0);
O && r.os === r.OS_IOS && 9 === r.osMainVersion && (s.indexedDB || (O = !1));
...
if (t.canPlayType) {
t.canPlayType('audio/ogg; codecs="vorbis"') && R.push(".ogg");
t.canPlayType("audio/mpeg") && R.push(".mp3");
t.canPlayType('audio/wav; codecs="1"') && R.push(".wav");
t.canPlayType("audio/mp4") && R.push(".mp4");
t.canPlayType("audio/x-m4a") && R.push(".m4a");
}
})();
L.format = R;
r.__audioSupport = L;
...
var n;
n = function() {};
i && u.extend(n, i.constructor);
var o = new n();
u.value(t, "__attrs__", o);
return o;
}
function s(t) {
for (var e, i = cc.Class.getInheritanceChain(t), n = i.length - 1; n >= 0; n--) {
var o = i[n];
o.hasOwnProperty("__attrs__") && o.__attrs__ || r(o, o, (e = i[n + 1]) && e.__attrs__);
}
r(t, t, (e = i[0]) && e.__attrs__);
return t.__attrs__;
}
function c(i, n, o) {
var s, c, h;
if ("function" === ("object" == (e = typeof i) ? t(i) : e)) c = (s = a(i)).constructor.prototype; else {
var l = i;
(s = l.__attrs__) || (s = r(l, i = l.constructor, a(i)));
c = s;
}
if ("undefined" === ("object" == (e = typeof o) ? t(o) : e)) {
var u = n + d, f = {};
for (h in s) h.startsWith(u) && (f[h.slice(u.length)] = s[h]);
return f;
}
if ("object" === ("object" == (e = typeof o) ? t(o) : e)) for (h in o) 95 !== h.charCodeAt(0) && (c[n + d + h] = o[h]);
}
function a(t) {
return t.hasOwnProperty("__attrs__") && t.__attrs__ || s(t);
}
function h(t) {
return a(t).constructor.prototype;
}
function l(t, e) {}
var u = i("./js"), d = (i("./utils").isPlainEmptyObj_DEV, "$_$");
cc.Integer = "Integer";
cc.Float = "Float";
cc.Boolean = "Boolean";
cc.String = "String";
...
145: [ (function(i, n, o) {
var r = i("./js"), s = function() {
this._callbackTable = {};
this._invoking = {};
this._toRemove = {};
this._toRemoveAll = null;
}, c = {};
s.REMOVE_PLACEHOLDER = c;
s.prototype._clearToRemove = function(t) {
var e = this._callbackTable[t];
if (this._toRemove[t] && e) {
for (var i = e.indexOf(c), n = i, o = i + 1; o < e.length; ++o) {
var r = e[o];
if (r !== c) {
e[n] = r;
++n;
...
s.prototype.add = function(i, n, o) {
var r = this._callbackTable[i];
if ("undefined" !== ("object" == (e = typeof r) ? t(r) : e)) {
"object" === ("object" == (e = typeof o) ? t(o) : e) ? r.push(n, o) : r.push(n);
return !1;
}
r = "object" === ("object" == (e = typeof o) ? t(o) : e) ? [ n, o ] : [ n ];
this._callbackTable[i] = r;
return !0;
};
s.prototype.has = function(i, n, o) {
if (this._toRemoveAll === i) return !1;
var r, s, a = this._callbackTable[i];
if (!a) return !1;
if (!n) {
if (this._toRemove[i]) {
for (s = 0; s < a.length; s++) if (a[s] !== c) return !0;
return !1;
}
return a.length > 0;
}
...
for (;-1 !== s; ) {
r = a[s + 1];
"object" !== ("object" == (e = typeof r) ? t(r) : e) && (r = void 0);
if (r === o) return !0;
s = cc.js.array.indexOf.call(a, n, s + 1);
}
return !1;
};
s.prototype.removeAll = function(i) {
if (this._invoking[i]) this._toRemoveAll = i; else if ("object" === ("object" == (e = typeof i) ? t(i) : e)) {
var n, o, r, s = i;
for (i in this._callbackTable) {
o = (n = this._callbackTable[i]).lastIndexOf(s);
for (;-1 !== o; ) {
r = n[o - 1];
"function" === ("object" == (e = typeof r) ? t(r) : e) ? n.splice(o - 1, 2) : n.splice(o, 1);
o = n.lastIndexOf(s);
}
}
} else {
delete this._callbackTable[i];
delete this._toRemove[i];
}
};
s.prototype.remove = function(i, n, o) {
var r, s, a = this._callbackTable[i];
if (a) {
r = a.indexOf(n);
for (;-1 !== r; ) {
s = a[r + 1];
"object" !== ("object" == (e = typeof s) ? t(s) : e) && (s = void 0);
if (s === o) {
a[r] = c;
s && (a[r + 1] = c);
this._toRemove[i] = !0;
...
r = cc.js.array.indexOf.call(a, n, r + 1);
}
return !0;
}
return !1;
...
r.extend(a, s);
a.prototype.invoke = function(i, n, o, r, s, a) {
this._invoking[i] = !0;
var h = this._callbackTable[i];
if (h) {
var l, u = h.length - 1;
for (l = 0; l <= u; ) {
var d = h[l], f = 1;
if (d !== c) {
var p = h[l + 1];
if (p && "object" === ("object" == (e = typeof p) ? t(p) : e)) {
d.call(p, n, o, r, s, a);
f = 2;
} else d(n, o, r, s, a);
}
...
this._invoking[i] = !1;
this._clearToRemove(i);
};
a.prototype.invokeAndRemove = function(i, n, o, r, s, a) {
this._invoking[i] = !0;
var h, l, u, d, f, p = this._callbackTable[i];
if (p) for (h = 0, l = p.length; h < l; ) {
u = 1;
if ((d = p[h]) !== c) if ((f = p[h + 1]) && "object" === ("object" == (e = typeof f) ? t(f) : e)) {
d.call(f, n, o, r, s, a);
u = 2;
} else d(n, o, r, s, a);
h += u;
...
a.prototype.bindKey = function(i, n) {
var o = this;
return function(r, s, c, a, h) {
var l, u, d, f = o._callbackTable[i];
if (f) for (l = 0, u = f.length; l < u; ) if ((d = f[l + 1]) && "object" === ("object" == (e = typeof d) ? t(d) : e)) {
f[l].call(d, r, s, c, a, h);
l += 2;
} else {
f[l](r, s, c, a, h);
++l;
...
a.CallbacksHandler = s;
n.exports = a;
}), {
"./js": 151
} ],
146: [ (function(i, n, o) {
var r = i("./js"), s = (i("./CCObject"), i("./attribute")), c = i("./CCClass"), a = function() {
this.uuidList = [];
this.uuidObjList = [];
this.uuidPropList = [];
this.rawProp = "";
...
function o(t, e) {
for (var i = s.DELIMETER + "rawType", n = (s.DELIMETER, s.DELIMETER + "serializable"), o = s.DELIMETER + "default", a = s.getClassAttrs(e), h = e.__props__, l = [ "var prop;" ], u = 0; u < h.length; u++) {
var d, f = h[u];
if (a[f + i]) {
d = c.IDENTIFIER_RE.test(f) ? '"' + f + '"' : c.escapeForJS(f);
l.push('if(s.result.rawProp)\ncc.error("not support multi raw object in a file");');
l.push("s.result.rawProp=" + d + ";");
} else {
if (!1 === a[f + n]) continue;
var p;
if (c.IDENTIFIER_RE.test(f)) {
d = '"' + f + '"';
p = "." + f;
} else p = "[" + (d = c.escapeForJS(f)) + "]";
l.push("prop=d" + p + ";");
l.push('if(typeof (prop)!=="undefined"){');
l.push('if(typeof (prop)!=="object"){o' + p + "=prop;");
l.push("}else{if(prop){");
var _ = c.getDefault(a[f + o]);
if (_ instanceof cc.ValueType) {
var g = r.getClassName(_);
l.push("s._deserializeTypedObject(o" + p + ",prop," + g + ");");
} else l.push("s._deserializeObjField(o,prop," + d + ");");
l.push("}else o" + p + "=null;}}");
}
}
if ("_$erialized" === h[h.length - 1]) {
l.push("o._$erialized=JSON.parse(JSON.stringify(d));");
l.push("s._deserializePrimitiveObject(o._$erialized,d);");
}
return Function("s", "o", "d", "k", "t", l.join(""));
}
function a(t, e, i, n, s) {
var c;
if (n.hasOwnProperty("__deserialize__")) c = n.__deserialize__; else {
c = o(t, n);
r.value(n, "__deserialize__", c, !0);
}
c(t, e, i, n, s);
}
var h = i.prototype;
h.deserialize = function(t) {
if (Array.isArray(t)) {
var e = t, i = e.length;
this.deserializedList.length = i;
for (var o = 0; o < i; o++) if (e[o]) {
this.deserializedList[o] = this._deserializeObject(e[o]);
}
...
h._deserializeObject = function(i, n, o, s) {
var c, h = null, l = null;
if (i.__type__) {
var u = i.__type__;
if (!(l = this._classFinder(u, i, o, s))) {
this._classFinder === r._getClassById && cc.deserialize.reportMissingClass(u);
return null;
}
h = new l();
l === cc.SpriteFrame && h.retain();
if (h._deserialize) {
h._deserialize(i.content, this);
return h;
}
cc.Class._isCCClass(l) ? a(this, h, i, l, n) : this._deserializeTypedObject(h, i, l);
} else if (Array.isArray(i)) {
h = new Array(i.length);
for (var d = 0; d < i.length; d++) {
c = i[d];
"object" === ("object" == (e = typeof c) ? t(c) : e) && c ? this._deserializeObjField(h, c, "" + d) : h[d] = c;
}
} else {
h = {};
...
h._deserializeObjField = function(i, n, o, r) {
var s = n.__id__;
...
h._deserializePrimitiveObject = function(i, n) {
var o = this;
for (var r in n) if (n.hasOwnProperty(r)) {
var s = n[r];
"object" !== ("object" == (e = typeof s) ? t(s) : e) ? "__type__" !== r && (i[r] = s) : s ? o._deserializeObjField(i, s, r) : i[r] = null;
}
};
h._deserializeTypedObject = function(i, n, o) {
if (o !== cc.Vec2) if (o !== cc.Color) {
var r = o.__props__;
r || (r = Object.keys(i));
for (var s = 0; s < r.length; s++) {
var c = r[s], a = n[c];
...
var s = (o = o || {}).classFinder || r._getClassById, c = o.createAssetRefs || cc.sys.platform === cc.sys.EDITOR_CORE, l = o.customEnv, u = o.ignoreEditorOnly;
"string" === ("object" == (e = typeof i) ? t(i) : e) && (i = JSON.parse(i));
var d = !n;
n = n || a.pool.get();
var f = h.pool.get(n, !1, s, l, u);
...
this.objs = [];
this.funcs = [];
this.funcModuleCache = v.createMap();
v.mixin(this.funcModuleCache, A);
this.globalVariables = [];
this.globalVariableId = 0;
this.localVariableId = 0;
this.codeArray.push(E + S + "," + x + ";", "if(R){", S + "=R;", "}else{", S + "=R=new " + this.getFuncModule(t.constructor, !0) + "();", "}");
t._iN$t = {
globalVar: "R"
};
...
var n = l([ "return (function(R){", i || [], this.codeArray, "return o;", "})" ], "");
...
var f = i("./CCObject"), p = f.Flags.Destroyed, _ = f.Flags.PersistentMask, g = i("./attribute"), v = i("./js"), y = i("./CCClass"), m = g.DELIMETER + "serializable", b = g.DELIMETER + "default", C = y.IDENTIFIER_RE, T = y.escapeForJS, E = "var ", S = "o", x = "t", A = {
"cc.Node": "cc.Node",
"cc.Sprite": "cc.Sprite",
"cc.Label": "cc.Label",
"cc.Button": "cc.Button",
...
for (var r = o.__props__, s = g.getClassAttrs(o), c = 0; c < r.length; c++) {
var a = r[c];
if (!1 !== s[a + m]) {
var l = n[a], d = s[a + b];
if (h(d, l)) continue;
if ("object" === ("object" == (e = typeof l) ? t(l) : e) && l instanceof cc.ValueType && ((d = y.getDefault(d)) && d.constructor) === l.constructor) {
var f = S + u(a);
this.setValueType(i, d, l, f);
continue;
}
this.setObjProp(i, n, a, l);
}
}
};
...
this.objsToClear_iN$t.push(t);
for (var n = 0; n < t.length; ++n) c(i, e + "[" + n + "]=", this.enumerateField(t, n, t[n]));
return i;
};
...
"_objFlags" === n && i instanceof f && (o &= _);
return o;
};
w.setObjProp = function(t, e, i, n) {
c(t, S + u(i) + "=", this.enumerateField(e, i, n));
};
...
if (i !== Object) return this.getObjRef(t);
e = new r(S, "{}");
}
var n = [ e ];
t._iN$t = {
...
n.exports = {
compile: function(t) {
return new d(t, t instanceof cc._BaseNode && t).result;
},
equalsToDefault: h
};
}), {
...
function r(i, n) {
if (!n) {
if ("object" !== ("object" == (e = typeof i) ? t(i) : e) || Array.isArray(i)) return null;
if (!i) return null;
...
if (i instanceof cc.Asset) return null;
}
cc.game._isCloning = !0;
o = s(i);
cc.game._isCloning = !1;
...
var i;
a(t, i = t._iN$t ? t._iN$t : new (0, t.constructor)(), e);
for (var n = 0, o = p.length; n < o; ++n) p[n]._iN$t = null;
p.length = 0;
return i;
}
function c(i, n, o, r) {
for (var s = i.__props__, c = f.getClassAttrs(i), a = 0; a < s.length; a++) {
var l = s[a];
if (!1 !== c[l + _]) {
var u = n[l];
"object" === ("object" == (e = typeof u) ? t(u) : e) && u ? o[l] = u._iN$t || h(u, r) : o[l] = u;
}
}
}
function a(i, n, o) {
...
p.push(i);
var r = i.constructor;
if (cc.Class._isCCClass(r)) c(r, i, n, o); else for (var s in i) if (i.hasOwnProperty(s) && (95 !== s.charCodeAt(0) || 95 !== s.charCodeAt(1) || "__type__" === s)) {
var a = i[s];
if ("object" === ("object" == (e = typeof a) ? t(a) : e) && a) {
if (a === n) continue;
n[s] = a._iN$t || h(a, o);
} else n[s] = a;
}
i instanceof l && (n._objFlags &= d);
}
function h(i, n) {
...
for (var s = 0; s < r; ++s) {
var c = i[s];
"object" === ("object" == (e = typeof c) ? t(c) : e) && c ? o[s] = c._iN$t || h(c, n) : o[s] = c;
}
p.push(i);
return o;
}
if (i._objFlags & u) return null;
var l = i.constructor;
...
} else if (l !== Object) return i;
a(i, o = new l(), n);
return o;
}
var l = i("./CCObject"), u = l.Flags.Destroyed, d = l.Flags.PersistentMask, f = i("./attribute"), p = (i("./utils").isDomNode, 
...
if ("function" === ("object" == (e = typeof i) ? t(i) : e) && i.prototype.hasOwnProperty("__cid__")) return i.prototype.__cid__;
if (i && i.constructor) {
var o = i.constructor.prototype;
if (o && o.hasOwnProperty("__cid__")) return i.__cid__;
}
return "";
};
})();
...
if (i) {
i.find = i.find || cc.$;
i.hasClass = i.hasClass || function(t) {
...
if (o && !this.getComponent(o) && !this.addComponent(o)) return null;
var r = new n();
r.node = this;
...
var t, e;
this._objFlags |= p;
var i = this._parent, n = i && i._objFlags & p, o = this._children;
...
var y = [ "name", "children", "childrenCount" ];
u.propertyDefine(v, y, {});
...
o.os !== o.OS_WINDOWS && o.os !== o.OS_LINUX || o.browser === o.BROWSER_TYPE_CHROME || r.imagePool.resize(0);
r.isBuiltinClassId = function(t) {
return t.startsWith("cc.") || t.startsWith("dragonBones.") || t.startsWith("sp.") || t.startsWith("ccsg.");
};
...
return "string" === ("object" == (e = typeof i) ? t(i) : e) ? new cc.Color().fromHEX(i) : "object" === ("object" == (e = typeof i) ? t(i) : e) ? new cc.Color(i.r, i.g, i.b, i.a) : new cc.Color(i, n, o, r);
};
...
e.fontName = "Arial";
e.fontSize = 12;
e.textAlign = cc.TextAlignment.CENTER;
e.verticalAlign = cc.VerticalTextAlignment.TOP;
...
e.shadowBlur = 0;
e.shadowOpacity = 1;
if (t && t instanceof Object) for (var i in t) e[i] = t[i];
};
cc.FontDefinition.prototype._getCanvasFontStr = function() {
var t = this.lineHeight.charAt ? this.lineHeight : this.lineHeight + "px";
...
176: [ (function(t, e, i) {
var n = cc.js;
n.obsolete(cc.loader, "cc.loader.loadResAll", "loadResDir");
}), {} ],
177: [ (function(t, e, i) {
t("./CCSGMotionStreak");
...
__preload: function() {
if (cc._renderType, cc.game.RENDER_TYPE_WEBGL, 1) {
...
"./CCSGMotionStreak": 218,
"./CCSGMotionStreakWebGLRenderCmd": 218
} ],
178: [ (function(t, e, i) {
var n = cc.Class({
...
t("./CCParticleBatchNode");
t("./CCParticleBatchNodeCanvasRenderCmd");
t("./CCParticleBatchNodeWebGLRenderCmd");
...
cc.isChildClassOf(n, cc.ValueType) ? o.set = function(e) {
this[i] = new n(e);
this._sgNode[t] = e;
} : o.set = function(e) {
this[i] = e;
...
_initSgNode: function() {
var t = this._sgNode;
this._file ? this._custom ? !this._texture ? this._applyFile() : this._applyCustoms() : this._applyFile() : this._custom && this._applyCustoms();
t.stopSystem();
},
...
"./CCParticleAsset": 178,
"./CCParticleBatchNode": 218,
"./CCParticleBatchNodeCanvasRenderCmd": 218,
"./CCParticleBatchNodeWebGLRenderCmd": 218,
"./CCSGParticleSystem": 218,
"./CCSGParticleSystemCanvasRenderCmd": 218,
"./CCSGParticleSystemWebGLRenderCmd": 218
} ],
180: [ (function(t, e, i) {
t("./CCSGTMXLayer");
...
"./CCSGTMXLayer": 218,
"./CCTMXLayerCanvasRenderCmd": 218,
"./CCTMXLayerWebGLRenderCmd": 218
} ],
181: [ (function(t, e, i) {
t("./CCTiledMapAsset");
t("./CCTiledLayer");
...
v = a[t];
var E = this._sgNode.getObjectGroup(v);
if ((m = T.indexOf(v)) < 0) {
var S = null;
if ((b = this.node.getChildByName(v)) && !b.getComponent(cc._SGComponent)) S = b.addComponent(cc.TiledObjectGroup); else {
b = new cc.Node(v);
this.node.addChild(b);
S = b.addComponent(cc.TiledObjectGroup);
}
b && S || cc.errorID(7202);
S._replaceSgNode(E);
b.setSiblingIndex(E.getLocalZOrder());
b.setAnchorPoint(this.node.getAnchorPoint());
S.enabled = E.isVisible();
}
}
var x = this.node.getChildren(), A = [];
for (t = 0, e = x.length; t < e; t++) {
l = (h = x[t]).getComponent(cc.TiledLayer);
u = h.getComponent(cc.TiledObjectGroup);
(l || u) && A.push(h._name);
}
var w = [], O = [], I = this._sgNode.getChildren();
for (t = 0, e = I.length; t < e; t++) if ((h = I[t]) instanceof _ccsg.TMXLayer) {
...
var N = w[t];
t !== A.indexOf(N) && this.node.getChildByName(N).setSiblingIndex(O[t].getLocalZOrder());
}
...
_applyFile: function() {
var t = this._sgNode, e = this._tmxFile, i = this;
if (e) {
var n = cc.url._rawAssets + e.tmxFolderPath;
n = cc.path.stripSep(n);
if (t.initWithXML(e.tmxXmlStr, n)) {
i._detachedChildren.length = 0;
i._onMapLoaded();
}
} else {
for (var o = t.allLayers(), r = 0, s = o.length; r < s; r++) t.removeChild(o[r]);
var c = t.getObjectGroups();
for (r = 0, s = c.length; r < s; r++) t.removeChild(c[r]);
this._detachedChildren.length = 0;
i._removeLayerEntities();
}
}
});
...
var i = t._sgNode = t._createSgNode();
if (i) {
i.retain();
t.enabledInHierarchy || i.setVisible(!1);
if (e) {
i._bubblingListeners = e;
...
var i = e[t];
void 0 !== i ? this.defaultSkin = i : cc.errorID(7501, this.name);
},
type: r,
visible: !0,
...
return this._sgNode ? this._sgNode.setAnimation(t, e, i) : null;
},
_sample: function() {
...
this._sgNode && this._sgNode.clearTrack(t);
},
_updateAnimEnum: !1,
_updateSkinEnum: !1,
...
"./SGSkeleton": 218,
"./SGSkeletonAnimation": 218,
"./SGSkeletonCanvasRenderCmd": 218,
"./SGSkeletonTexture": 191,
"./SGSkeletonWebGLRenderCmd": 218,
"./Skeleton": 192,
"./SkeletonData": 193,
"./lib/spine": 218
} ],
...
var n = A(e, i), o = y(C(n, A(t, i)) / D(n));
return x(i, O(n, o));
}, d = function(t, e, i, n, o, r) {
var s = i - o, c = n - r, a = y(T(s, c, t - o, e - r) / M(s, c));
return new m(o + s * a, r + c * a);
};
cp.momentForCircle = function(t, e, i, n) {
return t * (.5 * (e * e + i * i) + D(n));
};
...
var n = O(x(e, i), .5);
return t * (V(i, e) / 12 + D(n));
};
cp.areaForSegment = function(t, e, i) {
return i * (Math.PI * i + 2 * W(t, e));
};
cp.momentForPoly = function(t, e, i) {
for (var n = 0, o = 0, r = e.length, s = 0; s < r; s += 2) {
var c = e[s] + i.x, a = e[s + 1] + i.y, h = e[(s + 2) % r] + i.x, l = e[(s + 3) % r] + i.y, u = N(h, l, c, a);
n += u * (T(c, a, c, a) + T(c, a, h, l) + T(h, l, h, l));
o += u;
}
return t * n / (6 * o);
};
cp.areaForPoly = function(t) {
for (var e = 0, i = 0, n = t.length; i < n; i += 2) e += I(new m(t[i], t[i + 1]), new m(t[(i + 2) % n], t[(i + 3) % n]));
return -e / 2;
};
cp.centroidForPoly = function(t) {
for (var e = 0, i = new m(0, 0), n = 0, o = t.length; n < o; n += 2) {
var r = new m(t[n], t[n + 1]), s = new m(t[(n + 2) % o], t[(n + 3) % o]), c = I(r, s);
e += c;
i = x(i, O(x(r, s), c));
}
return O(i, 1 / (3 * e));
...
return cp.momentForBox(t, i, n) + t * D(o);
};
var f = cp.loopIndexes = function(t) {
var e, i, n, o, r = 0, s = 0;
e = n = t[0];
i = o = t[1];
...
t[2 * e + 1] = t[2 * i + 1];
t[2 * i + 1] = n;
}, _ = function(t, e, i, n, o, r) {
if (0 === i) return 0;
for (var s = 0, c = e, a = A(o, n), h = r * E(a), l = e, u = e + i - 1; l <= u; ) {
var d = new m(t[2 * l], t[2 * l + 1]), f = I(a, A(d, n));
if (f > h) {
if (f > s) {
s = f;
c = l;
...
var a = _(e, i, n, o, r, t), h = new m(e[2 * i], e[2 * i + 1]), l = g(t, e, i + 1, a - 1, o, h, r, c), u = c + l++;
e[2 * u] = r.x;
e[2 * u + 1] = r.y;
var d = _(e, i + a, n - a, r, s, t), f = new m(e[2 * (i + a)], e[2 * (i + a) + 1]);
return l + g(t, e, i + a + 1, d - 1, r, f, s, c + l);
};
cp.convexHull = function(t, e, i) {
if (e) for (var n = 0; n < t.length; n++) e[n] = t[n]; else e = t;
var o = f(t), r = o[0], s = o[1];
if (r == s) {
e.length = 2;
return e;
}
p(e, 0, r);
p(e, 1, 0 == s ? r : s);
var c = new m(e[0], e[1]), h = new m(e[2], e[3]), l = t.length >> 1, u = g(i, e, 2, l - 2, c, h, c, 1) + 1;
e.length = 2 * u;
a(it(e), "Internal error: cpConvexHull() and cpPolyValidate() did not agree.Please report this error with as much info as you can.");
return e;
};
...
var b = cp.vzero = new m(0, 0), C = cp.v.dot = function(t, e) {
return t.x * e.x + t.y * e.y;
}, T = function(t, e, i, n) {
return t * i + e * n;
}, E = cp.v.len = function(t) {
return Math.sqrt(C(t, t));
}, S = cp.v.len2 = function(t, e) {
return Math.sqrt(t * t + e * e);
}, x = (cp.v.eql = function(t, e) {
return t.x === e.x && t.y === e.y;
}, cp.v.add = function(t, e) {
return new m(t.x + e.x, t.y + e.y);
});
...
var I = cp.v.cross = function(t, e) {
return t.x * e.y - t.y * e.x;
}, N = function(t, e, i, n) {
return t * n - e * i;
}, L = cp.v.perp = function(t) {
return new m(-t.y, t.x);
}, R = (cp.v.pvrperp = function(t) {
return new m(t.y, -t.x);
}, cp.v.project = function(t, e) {
return O(e, C(t, e) / D(e));
});
m.prototype.project = function(t) {
this.mult(C(this, t) / D(t));
return this;
};
var P = cp.v.rotate = function(t, e) {
return new m(t.x * e.x - t.y * e.y, t.x * e.y + t.y * e.x);
};
...
var B = cp.v.unrotate = function(t, e) {
return new m(t.x * e.x + t.y * e.y, t.y * e.x - t.x * e.y);
}, D = cp.v.lengthsq = function(t) {
return C(t, t);
}, M = cp.v.lengthsq2 = function(t, e) {
return t * t + e * e;
}, F = cp.v.lerp = function(t, e, i) {
return x(O(t, 1 - i), O(e, i));
}, j = cp.v.normalize = function(t) {
return O(t, 1 / E(t));
}, k = cp.v.normalize_safe = function(t) {
return 0 === t.x && 0 === t.y ? b : j(t);
}, z = cp.v.clamp = function(t, e) {
return C(t, t) > e * e ? O(j(t), e) : t;
}, W = (cp.v.lerpconst = function(t, e, i) {
return x(t, z(A(e, t), i));
}, cp.v.dist = function(t, e) {
return E(A(t, e));
}), V = cp.v.distsq = function(t, e) {
return D(A(t, e));
}, G = (cp.v.near = function(t, e, i) {
return V(t, e) < i * i;
...
return t;
}), H = (cp.v.slerpconst = function(t, e, i) {
var n = Math.acos(C(t, e));
return G(t, e, r(i, n) / n);
...
}, J = 0, q = (cp.NO_GROUP = 0, cp.ALL_LAYERS = -1);
...
var $ = cp.CircleShape = function(t, e, i) {
this.c = this.tc = i;
this.r = e;
this.type = "circle";
Q.call(this, t);
...
$.prototype.cacheData = function(t, e) {
var i = this.tc = P(this.c, e).add(t), n = this.r;
this.bb_l = i.x - n;
this.bb_b = i.y - n;
this.bb_r = i.x + n;
this.bb_t = i.y + n;
...
var e = t.x - this.tc.x, i = t.y - this.tc.y, n = S(e, i), o = this.r, r = new m(this.tc.x + e * o / n, this.tc.y + i * o / n);
return new Z(this, r, n - o);
};
var tt = function(t, e, i, n, o, r) {
n = A(n, e);
o = A(o, e);
var s = C(n, n) - 2 * C(n, o) + C(o, o), c = -2 * C(n, n) + 2 * C(n, o), a = c * c - 4 * s * (C(n, n) - i * i);
if (a >= 0) {
var h = (-c - Math.sqrt(a)) / (2 * s);
if (0 <= h && h <= 1) return new K(t, h, j(F(n, o, h)));
}
};
$.prototype.segmentQuery = function(t, e) {
return tt(this, this.tc, this.r, t, e);
};
var et = cp.SegmentShape = function(t, e, i, n) {
this.a = e;
this.b = i;
this.n = L(j(A(i, e)));
...
et.prototype = Object.create(Q.prototype);
et.prototype.cacheData = function(t, e) {
this.ta = x(t, P(this.a, e));
this.tb = x(t, P(this.b, e));
this.tn = P(this.n, e);
var i, n, o, r;
...
et.prototype.nearestPointQuery = function(t) {
var e = u(t, this.ta, this.tb), i = t.x - e.x, n = t.y - e.y, o = S(i, n), r = this.r, s = o ? x(e, O(new m(i, n), r / o)) : e;
return new Z(this, s, o - r);
};
et.prototype.segmentQuery = function(t, e) {
var i = this.tn, n = C(A(this.ta, t), i), o = this.r, r = n > 0 ? w(i) : i, s = A(O(r, o), t), c = x(this.ta, s), a = x(this.tb, s), h = A(e, t);
if (I(h, c) * I(h, a) <= 0) {
var l = n + (n > 0 ? -o : o), u = -l, d = C(h, i) - l;
if (u * d < 0) return new K(this, u / (u - d), r);
} else if (0 !== o) {
var f = tt(this, this.ta, this.r, t, e), p = tt(this, this.tb, this.r, t, e);
return f ? p && p.t < f.t ? p : f : p;
}
};
et.prototype.setNeighbors = function(t, e) {
this.a_tangent = A(t, this.a);
this.b_tangent = A(e, this.b);
};
et.prototype.setEndpoints = function(t, e) {
this.a = t;
this.b = e;
this.n = L(j(A(e, t)));
};
...
if (N(r - n, s - o, c - r, a - s) > 0) return !1;
}
return !0;
}, nt = cp.PolyShape = function(t, e, i) {
this.setVerts(e, i);
this.type = "poly";
Q.call(this, t);
};
nt.prototype = Object.create(Q.prototype);
var ot = function(t, e) {
this.n = t;
this.d = e;
};
ot.prototype.compare = function(t) {
return C(this.n, t) - this.d;
};
nt.prototype.setVerts = function(i, n) {
...
c(it(i), "Polygon is concave or has a reversed winding. Consider using cpConvexHull()");
...
for (var s = 0; s < o; s += 2) {
var a = i[s] + n.x, h = i[s + 1] + n.y, l = i[(s + 2) % o] + n.x, u = i[(s + 3) % o] + n.y, d = j(L(new m(l - a, u - h)));
this.verts[s] = a;
this.verts[s + 1] = h;
this.planes[s >> 1] = new ot(d, T(d.x, d.y, a, h));
this.tPlanes[s >> 1] = new ot(new m(0, 0), 0);
}
};
cp.BoxShape = function(t, e, i) {
var n = e / 2, o = i / 2;
return rt(t, new U(-n, -o, n, o));
};
var rt = cp.BoxShape2 = function(t, e) {
var i = [ e.l, e.b, e.l, e.t, e.r, e.t, e.r, e.b ];
return new nt(t, i, b);
};
nt.prototype.transformVerts = function(t, e) {
...
nt.prototype.transformAxes = function(t, e) {
...
nt.prototype.cacheData = function(t, e) {
this.transformAxes(t, e);
this.transformVerts(t, e);
};
nt.prototype.nearestPointQuery = function(t) {
for (var e = this.tPlanes, i = this.tVerts, n = i[i.length - 2], o = i[i.length - 1], r = Infinity, s = b, c = !1, a = 0; a < e.length; a++) {
e[a].compare(t) > 0 && (c = !0);
var h = i[2 * a], l = i[2 * a + 1], u = d(t.x, t.y, n, o, h, l), f = W(t, u);
if (f < r) {
r = f;
s = u;
}
...
nt.prototype.segmentQuery = function(t, e) {
for (var i = this.tPlanes, n = this.tVerts, o = i.length, r = 2 * o, s = 0; s < o; s++) {
var c = i[s].n, a = C(t, c);
if (!(i[s].d > a)) {
var h = C(e, c), l = (i[s].d - a) / (h - a);
if (!(l < 0 || 1 < l)) {
var u = F(t, e, l), d = -I(c, u), f = -N(c.x, c.y, n[2 * s], n[2 * s + 1]), p = -N(c.x, c.y, n[(2 * s + 2) % r], n[(2 * s + 3) % r]);
if (f <= d && d <= p) return new K(this, l, c);
}
}
}
};
nt.prototype.valueOnAxis = function(t, e) {
for (var i = this.tVerts, n = T(t.x, t.y, i[0], i[1]), o = 2; o < i.length; o += 2) n = r(n, T(t.x, t.y, i[o], i[o + 1]));
return n - e;
};
nt.prototype.containsVert = function(t, e) {
for (var i = this.tPlanes, n = 0; n < i.length; n++) {
var o = i[n].n;
if (T(o.x, o.y, t, e) - i[n].d > 0) return !1;
}
return !0;
};
nt.prototype.containsVertPartial = function(t, e, i) {
for (var n = this.tPlanes, o = 0; o < n.length; o++) {
var r = n[o].n;
if (!(C(r, i) < 0) && T(r.x, r.y, t, e) - n[o].d > 0) return !1;
}
return !0;
};
nt.prototype.getNumVerts = function() {
return this.verts.length / 2;
};
nt.prototype.getVert = function(t) {
return new m(this.verts[2 * t], this.verts[2 * t + 1]);
};
var st = cp.Body = function(t, e) {
this.p = new m(0, 0);
this.vx = this.vy = 0;
this.f = new m(0, 0);
this.w = 0;
...
var t = new st(Infinity, Infinity);
...
ht(this.p, "Body's position is invalid.");
ht(this.f, "Body's force is invalid.");
...
ht(this.rot, "Body's rotation vector is invalid.");
...
st.prototype.setMass = function(t) {
c(t > 0, "Mass must be positive and non-zero.");
this.activate();
this.m = t;
this.m_inv = 1 / t;
};
st.prototype.setMoment = function(t) {
...
st.prototype.removeShape = function(t) {
l(this.shapeList, t);
};
var lt = function(t, e, i) {
if (t === i) return t.next(e);
t.a === e ? t.next_a = lt(t.next_a, e, i) : t.next_b = lt(t.next_b, e, i);
return t;
};
st.prototype.removeConstraint = function(t) {
this.constraintList = lt(this.constraintList, this, t);
};
...
st.prototype.setVel = function(t) {
this.activate();
this.vx = t.x;
this.vy = t.y;
};
st.prototype.setAngVel = function(t) {
this.activate();
this.w = t;
};
st.prototype.setAngleInternal = function(t) {
c(!isNaN(t), "Internal Error: Attempting to set body's angle to NaN");
this.a = t;
this.rot.x = Math.cos(t);
this.rot.y = Math.sin(t);
};
st.prototype.setAngle = function(t) {
this.activate();
this.sanityCheck();
this.setAngleInternal(t);
};
st.prototype.velocity_func = function(t, e, i) {
...
this.vy = o * c;
var a = this.w_limit;
this.w = v(this.w * e + this.t * this.i_inv * i, -a, a);
this.sanityCheck();
};
st.prototype.position_func = function(t) {
...
st.prototype.applyForce = function(t, e) {
this.activate();
this.f = x(this.f, t);
this.t += I(e, t);
};
st.prototype.applyImpulse = function(t, e) {
this.activate();
ce(this, t.x, t.y, e);
};
st.prototype.getVelAtPoint = function(t) {
return x(new m(this.vx, this.vy), O(L(t), this.w));
};
st.prototype.getVelAtWorldPoint = function(t) {
return this.getVelAtPoint(A(t, this.p));
};
st.prototype.getVelAtLocalPoint = function(t) {
return this.getVelAtPoint(P(t, this.rot));
};
st.prototype.eachShape = function(t) {
for (var e = 0, i = this.shapeList.length; e < i; e++) t(this.shapeList[e]);
};
st.prototype.eachConstraint = function(t) {
...
st.prototype.eachArbiter = function(t) {
...
st.prototype.local2World = function(t) {
return x(this.p, P(t, this.rot));
};
st.prototype.world2Local = function(t) {
return B(A(t, this.p), this.rot);
};
st.prototype.kineticEnergy = function() {
var t = this.vx * this.vx + this.vy * this.vy, e = this.w * this.w;
return (t ? t * this.m : 0) + (e ? e * this.i : 0);
};
var ut = cp.SpatialIndex = function(t) {
this.staticIndex = t;
if (t) {
...
ut.prototype.collideStatic = function(t, e) {
if (t.count > 0) {
var i = t.query;
...
dt.prototype.makeNode = function(t, e) {
...
dt.prototype.getBB = function(t, e) {
...
dt.prototype.makePair = function(t, e, i, n) {
...
yt.prototype.recycle = function(t) {
...
gt.prototype.clearPairs = function(t) {
var e, i = this.pairs;
this.pairs = null;
for (;i; ) {
if (i.leafA === this) {
e = i.nextA;
mt(i.prevB, i.leafB, i.nextB);
} else {
e = i.nextB;
mt(i.prevA, i.leafA, i.nextA);
}
i.recycle(t);
i = e;
}
...
gt.prototype.recycle = function(t) {};
pt.prototype.setA = function(t) {
this.A = t;
t.parent = this;
};
pt.prototype.setB = function(t) {
this.B = t;
t.parent = this;
};
gt.prototype.isLeaf = !0;
pt.prototype.isLeaf = !1;
pt.prototype.otherChild = function(t) {
return this.A == t ? this.B : this.A;
};
pt.prototype.replaceChild = function(t, e, i) {
...
pt.prototype.bbArea = gt.prototype.bbArea = function() {
...
var n = t.B.bbArea() + Ct(t.A, e), o = t.A.bbArea() + Ct(t.B, e);
if (n === o) {
n = Tt(t.A, e);
o = Tt(t.B, e);
}
o < n ? t.setB(Et(t.B, e, i)) : t.setA(Et(t.A, e, i));
...
pt.prototype.intersectsBB = gt.prototype.intersectsBB = function(t) {
...
var s = xt(t.A, e, i), c = xt(t.B, e, i);
if (s < c) {
s < n && (n = r(n, At(t.A, e, i, n, o)));
c < n && (n = r(n, At(t.B, e, i, n, o)));
} else {
c < n && (n = r(n, At(t.B, e, i, n, o)));
s < n && (n = r(n, At(t.A, e, i, n, o)));
}
...
dt.prototype.subtreeRecycle = function(t) {
if (t.isLeaf) {
...
gt.prototype.markLeafQuery = function(t, e, i, n) {
if (Ot(t, this)) if (e) bt(t, this, i); else {
this.stamp < t.stamp && bt(this, t, i);
n && n(t.obj, this.obj);
}
};
pt.prototype.markLeafQuery = function(t, e, i, n) {
if (Ot(t, this)) {
this.A.markLeafQuery(t, e, i, n);
this.B.markLeafQuery(t, e, i, n);
}
};
gt.prototype.markSubtree = function(t, e, i) {
...
pt.prototype.markSubtree = function(t, e, i) {
this.A.markSubtree(t, e, i);
this.B.markSubtree(t, e, i);
};
gt.prototype.containsObj = function(t) {
...
gt.prototype.addPairs = function(t) {
...
var i = new gt(this, t);
this.leaves[e] = i;
this.root = Et(this.root, i, this);
this.count++;
i.stamp = this.getStamp();
i.addPairs(this);
this.incrementStamp();
};
dt.prototype.remove = function(t, e) {
var i = this.leaves[e];
delete this.leaves[e];
this.root = wt(this.root, i, this);
this.count--;
i.clearPairs(this);
i.recycle(this);
};
dt.prototype.contains = function(t, e) {
return null != this.leaves[e];
};
var It = function(t, e) {};
dt.prototype.reindexQuery = function(t) {
if (this.root) {
var e, i = this.leaves;
...
dt.prototype.reindex = function() {
this.reindexQuery(It);
};
dt.prototype.reindexObject = function(t, e) {
var i = this.leaves[e];
if (i) {
...
dt.prototype.pointQuery = function(t, e) {
this.query(new U(t.x, t.y, t.x, t.y), e);
};
dt.prototype.segmentQuery = function(t, e, i, n) {
this.root && At(this.root, t, e, i, n);
};
dt.prototype.query = function(t, e) {
this.root && St(this.root, t, e);
};
dt.prototype.count = function() {
return this.count;
};
dt.prototype.each = function(t) {
var e;
for (e in this.leaves) t(this.leaves[e].obj);
};
var Nt = function(t, e, i, n, o) {
return (s(t.bb_r, n) - r(t.bb_l, e)) * (s(t.bb_t, o) - r(t.bb_b, i));
}, Lt = function(t, e, i, n) {
if (1 == n) return e[i];
if (2 == n) return t.makeNode(e[i], e[i + 1]);
for (var o = (x = e[i]).bb_l, c = x.bb_b, a = x.bb_r, h = x.bb_t, l = i + n, u = i + 1; u < l; u++) {
x = e[u];
o = r(o, x.bb_l);
c = r(c, x.bb_b);
a = s(a, x.bb_r);
...
if (E == n) {
for (var x = null, u = i; u < l; u++) x = Et(x, e[u], t);
return x;
}
return NodeNew(t, Lt(t, e, i, E - i), Lt(t, e, E, l - E));
};
dt.prototype.optimize = function() {
var t = new Array(this.count), e = 0;
for (var i in this.leaves) t[e++] = this.nodes[i];
tree.subtreeRecycle(root);
this.root = Lt(tree, t, t.length);
};
var Rt = function(t, e) {
if (!t.isLeaf && e <= 10) {
Rt(t.A, e + 1);
...
this.root && Rt(this.root, 0);
};
var Pt = cp.CollisionHandler = function() {
this.a = this.b = 0;
};
Pt.prototype.begin = function(t, e) {
return !0;
};
Pt.prototype.preSolve = function(t, e) {
return !0;
};
Pt.prototype.postSolve = function(t, e) {};
Pt.prototype.separate = function(t, e) {};
var Bt = function(t, e) {
this.e = 0;
this.u = 0;
this.surface_vr = b;
...
for (var t = this.contacts, e = new m(0, 0), i = 0, n = t.length; i < n; i++) {
var o = t[i];
e.add(O(o.n, o.jnAcc));
}
...
for (var t = this.contacts, e = new m(0, 0), i = 0, n = t.length; i < n; i++) {
var o = t[i];
e.add(new m(o.jnAcc, o.jtAcc).rotate(o.n));
}
return this.swappedColl ? e : e.neg();
};
...
for (t = 0; t < e.length; t++) e[t] = new Dt(this.contacts[t].p, this.contacts[t].n, this.contacts[t].dist);
return e;
};
Bt.prototype.getNormal = function(t) {
var e = this.contacts[t].n;
return this.swappedColl ? w(e) : e;
};
...
Mt(0, this.body_a, this.thread_a_prev, this.thread_a_next);
Mt(0, this.body_b, this.thread_b_prev, this.thread_b_next);
this.thread_a_prev = this.thread_a_next = null;
this.thread_b_prev = this.thread_b_next = null;
};
Bt.prototype.update = function(t, e, i, n) {
...
this.e = i.e * n.e;
this.u = i.u * n.u;
this.surface_vr = A(i.surface_v, n.surface_v);
this.a = i;
this.body_a = i.body;
this.b = n;
this.body_b = n.body;
...
c.r1 = A(c.p, n.p);
c.r2 = A(c.p, o.p);
c.nMass = 1 / ue(n, o, c.r1, c.r2, c.n);
c.tMass = 1 / ue(n, o, c.r1, c.r2, L(c.n));
c.bias = -i * r(0, c.dist + e) / t;
c.jBias = 0;
c.bounce = se(n, o, c.r1, c.r2, c.n) * this.e;
}
};
...
jt++;
var r = this.contacts[o], c = r.nMass, a = r.n, h = r.r1, l = r.r2, u = e.vx - l.y * e.w - (t.vx - h.y * t.w), d = e.vy + l.x * e.w - (t.vy + h.x * t.w), f = a.x * (e.v_biasx - l.y * e.w_bias - t.v_biasx + h.y * t.w_bias) + a.y * (l.x * e.w_bias + e.v_biasy - h.x * t.w_bias - t.v_biasy), p = T(u, d, a.x, a.y), _ = T(u + i.x, d + i.y, -a.y, a.x), g = (r.bias - f) * c, y = r.jBias;
r.jBias = s(y + g, 0);
var m = -(r.bounce + p) * c, b = r.jnAcc;
r.jnAcc = s(b + m, 0);
var C = n * r.jnAcc, E = -_ * r.tMass, S = r.jtAcc;
r.jtAcc = v(S + E, -C, C);
var x = a.x * (r.jBias - y), A = a.y * (r.jBias - y);
he(t, -x, -A, h);
he(e, x, A, l);
var w = r.jnAcc - b, O = r.jtAcc - S;
ae(t, e, h, l, a.x * w - a.y * O, a.x * O + a.y * w);
}
};
...
this.hash = n;
kt++;
}, Wt = [], Vt = function(t, e, i, n) {
var o = i + n, r = A(e, t), s = D(r);
if (!(s >= o * o)) {
var c = Math.sqrt(s);
return new zt(x(t, O(r, .5 + (i - .5 * o) / (c || Infinity))), c ? O(r, 1 / c) : new m(1, 0), c - o, 0);
}
}, Gt = 0, Ht = function(t, e) {
...
var c = r[s], a = r[s + 1];
e.containsVertPartial(c, a, w(i)) && o.push(new zt(new m(c, a), i, n, h(t.hashid, s)));
}
for (var l = e.tVerts, s = 0; s < l.length; s += 2) {
var c = l[s], a = l[s + 1];
t.containsVertPartial(c, a, i) && o.push(new zt(new m(c, a), i, n, h(e.hashid, s)));
}
return o;
}, Yt = function(t, e, i, n) {
for (var o = [], r = t.tVerts, s = 0; s < r.length; s += 2) {
var c = r[s], a = r[s + 1];
e.containsVert(c, a) && o.push(new zt(new m(c, a), i, n, h(t.hashid, s >> 1)));
}
for (var l = e.tVerts, s = 0; s < l.length; s += 2) {
var c = l[s], a = l[s + 1];
t.containsVert(c, a) && o.push(new zt(new m(c, a), i, n, h(e.hashid, s >> 1)));
}
return o.length ? o : Ut(t, e, i, n);
}, Xt = function(t, e, i) {
var n = C(e, t.ta) - t.r, o = C(e, t.tb) - t.r;
return r(n, o) - i;
}, Jt = function(t, e, i, n, o) {
for (var r = I(e.tn, e.ta), s = I(e.tn, e.tb), c = O(e.tn, o), a = i.tVerts, l = 0; l < a.length; l += 2) {
var u = a[l], d = a[l + 1];
if (T(u, d, c.x, c.y) < C(e.tn, e.ta) * o + e.r) {
var f = N(e.tn.x, e.tn.y, u, d);
r >= f && f >= s && t.push(new zt(new m(u, d), c, n, h(i.hashid, l)));
}
}
};
$.prototype.collisionCode = 0;
et.prototype.collisionCode = 1;
nt.prototype.collisionCode = 2;
$.prototype.collisionTable = [ function(t, e) {
var i = Vt(t.tc, e.tc, t.r, e.r);
return i ? [ i ] : Wt;
}, function(t, e) {
var i = e.ta, n = e.tb, o = t.tc, r = A(n, i), s = y(C(r, A(o, i)) / D(r)), c = x(i, O(r, s)), a = Vt(o, c, t.r, e.r);
if (a) {
var h = a.n;
return 0 === s && C(h, e.a_tangent) < 0 || 1 === s && C(h, e.b_tangent) < 0 ? Wt : [ a ];
}
return Wt;
}, function(t, e) {
for (var i = e.tPlanes, n = 0, o = C(i[0].n, t.tc) - i[0].d - t.r, r = 0; r < i.length; r++) {
var s = C(i[r].n, t.tc) - i[r].d - t.r;
if (s > 0) return Wt;
if (s > o) {
o = s;
n = r;
...
var c = i[n].n, a = e.tVerts, h = a.length, l = n << 1, u = a[l], d = a[l + 1], f = a[(l + 2) % h], p = a[(l + 3) % h], _ = N(c.x, c.y, u, d), g = N(c.x, c.y, f, p), v = I(c, t.tc);
if (v < g) return (y = Vt(t.tc, new m(f, p), t.r, 0)) ? [ y ] : Wt;
if (v < _) return [ new zt(A(t.tc, O(c, t.r + o / 2)), w(c), o, 0) ];
var y = Vt(t.tc, new m(u, d), t.r, 0);
return y ? [ y ] : Wt;
} ];
et.prototype.collisionTable = [ null, function(t, e) {
return Wt;
}, function(t, e) {
var i = [], n = e.tPlanes, o = n.length, r = C(t.tn, t.ta), s = e.valueOnAxis(t.tn, r) - t.r, c = e.valueOnAxis(w(t.tn), -r) - t.r;
if (c > 0 || s > 0) return Wt;
var a = 0, l = Xt(t, n[0].n, n[0].d);
if (l > 0) return Wt;
for (var u = 0; u < o; u++) {
var d = Xt(t, n[u].n, n[u].d);
if (d > 0) return Wt;
if (d > l) {
l = d;
a = u;
...
var f = w(n[a].n), p = x(t.ta, O(f, t.r)), _ = x(t.tb, O(f, t.r));
e.containsVert(p.x, p.y) && i.push(new zt(p, f, l, h(t.hashid, 0)));
e.containsVert(_.x, _.y) && i.push(new zt(_, f, l, h(t.hashid, 1)));
(s >= l || c >= l) && (s > c ? Jt(i, t, e, s, 1) : Jt(i, t, e, c, -1));
if (0 === i.length) {
var g, v = 2 * a, y = e.tVerts, b = new m(y[v], y[v + 1]);
if (g = Vt(t.ta, b, t.r, 0)) return [ g ];
if (g = Vt(t.tb, b, t.r, 0)) return [ g ];
var T = 2 * o, E = new m(y[(v + 2) % T], y[(v + 3) % T]);
if (g = Vt(t.ta, E, t.r, 0)) return [ g ];
if (g = Vt(t.tb, E, t.r, 0)) return [ g ];
}
return i;
} ];
nt.prototype.collisionTable = [ null, null, function(t, e) {
var i = Ht(e, t.tPlanes);
if (-1 == i) return Wt;
var n = Gt, o = Ht(t, e.tPlanes);
if (-1 == o) return Wt;
var r = Gt;
return n > r ? Yt(t, e, t.tPlanes[i].n, n) : Yt(t, e, w(e.tPlanes[o].n), r);
} ];
var qt = cp.collideShapes = function(t, e) {
c(t.collisionCode <= e.collisionCode, "Collided shapes must be sorted by type");
return t.collisionTable[e.collisionCode](t, e);
}, Qt = new Pt(), Zt = cp.Space = function() {
this.stamp = 0;
this.curr_dt = 0;
this.bodies = [];
this.rousedBodies = [];
this.sleepingComponents = [];
this.staticShapes = new dt(null);
this.activeShapes = new dt(this.staticShapes);
this.arbiters = [];
...
this.staticBody = new st(Infinity, Infinity);
this.staticBody.nodeIdleTime = Infinity;
this.collideShapes = this.makeCollideShapes();
};
Zt.prototype.getCurrentTimeStep = function() {
return this.curr_dt;
};
Zt.prototype.setIterations = function(t) {
this.iterations = t;
};
Zt.prototype.isLocked = function() {
return this.locked;
};
var Kt = function(t) {
...
Zt.prototype.addCollisionHandler = function(t, e, i, n, o, r) {
Kt(this);
...
o && (s.postSolve = o);
r && (s.separate = r);
this.collisionHandlers[h(t, e)] = s;
};
Zt.prototype.removeCollisionHandler = function(t, e) {
Kt(this);
delete this.collisionHandlers[h(t, e)];
};
Zt.prototype.setDefaultCollisionHandler = function(t, e, i, n) {
Kt(this);
var o = new Pt();
t && (o.begin = t);
e && (o.preSolve = e);
...
Zt.prototype.lookupHandler = function(t, e) {
return this.collisionHandlers[h(t, e)] || this.defaultHandler;
};
...
Zt.prototype.addStaticShape = function(t) {
c(!t.space, "This shape is already added to a space and cannot be added to another.");
Kt(this);
var e = t.body;
e.addShape(t);
...
Zt.prototype.addBody = function(t) {
...
Zt.prototype.addConstraint = function(t) {
c(!t.space, "This shape is already added to a space and cannot be added to another.");
Kt(this);
var e = t.a, i = t.b;
e.activate();
...
Zt.prototype.filterArbiters = function(t, e) {
...
Zt.prototype.removeShape = function(t) {
var e = t.body;
...
Zt.prototype.removeStaticShape = function(t) {
...
Zt.prototype.removeBody = function(t) {
...
Zt.prototype.removeConstraint = function(t) {
c(this.containsConstraint(t), "Cannot remove a constraint that was not added to the space. (Removed twice maybe?)");
Kt(this);
t.a.activate();
t.b.activate();
l(this.constraints, t);
t.a.removeConstraint(t);
t.b.removeConstraint(t);
t.space = null;
};
Zt.prototype.containsShape = function(t) {
return t.space === this;
};
Zt.prototype.containsBody = function(t) {
return t.space == this;
};
Zt.prototype.containsConstraint = function(t) {
return t.space == this;
};
Zt.prototype.uncacheArbiter = function(t) {
delete this.cachedArbiters[h(t.a.hashid, t.b.hashid)];
l(this.arbiters, t);
};
Zt.prototype.eachBody = function(t) {
this.lock();
for (var e = this.bodies, i = 0; i < e.length; i++) t(e[i]);
for (var n = this.sleepingComponents, i = 0; i < n.length; i++) for (var o = n[i]; o; ) {
var r = o.nodeNext;
t(o);
o = r;
}
...
Zt.prototype.eachShape = function(t) {
this.lock();
this.activeShapes.each(t);
this.staticShapes.each(t);
this.unlock(!0);
};
Zt.prototype.eachConstraint = function(t) {
this.lock();
for (var e = this.constraints, i = 0; i < e.length; i++) t(e[i]);
this.unlock(!0);
};
Zt.prototype.reindexStatic = function() {
...
Zt.prototype.reindexShape = function(t) {
c(!this.locked, "You cannot manually reindex objects while the space is locked. Wait until the current query or step is complete.");
var e = t.body;
t.update(e.p, e.rot);
...
Zt.prototype.reindexShapesForBody = function(t) {
for (var e = t.shapeList; e; e = e.next) this.reindexShape(e);
};
Zt.prototype.useSpatialHash = function(t, e) {
throw new Error("Spatial Hash not implemented.");
};
Zt.prototype.activateBody = function(t) {
...
for (var n = t.arbiterList; n; n = n.next(t)) if (t === (a = n.body_a) || a.isStatic()) {
var o = n.a, r = n.b;
this.cachedArbiters[h(o.hashid, r.hashid)] = n;
n.stamp = this.stamp;
...
var a = s.a;
(t === a || a.isStatic()) && this.constraints.push(s);
}
}
};
Zt.prototype.deactivateBody = function(t) {
...
for (var n = t.arbiterList; n; n = n.next(t)) (t === (r = n.body_a) || r.isStatic()) && this.uncacheArbiter(n);
for (var o = t.constraintList; o; o = o.nodeNext) {
var r = o.a;
(t === r || r.isStatic()) && l(this.constraints, o);
}
};
var $t = function(t) {
...
st.prototype.activateStatic = function(t) {
...
st.prototype.pushArbiter = function(t) {
...
if (null == i) {
ee(t, e);
for (var n = e.arbiterList; n; n = n.next(e)) ie(t, e == n.body_a ? n.body_b : n.body_a);
for (var o = e.constraintList; o; o = o.next(e)) ie(t, e == o.a ? o.b : o.a);
...
Zt.prototype.processComponents = function(t) {
for (var e = Infinity !== this.sleepTimeThreshold, i = this.bodies, n = 0; n < i.length; n++) {
s = i[n];
a(null === s.nodeNext, "Internal Error: Dangling next pointer detected in contact graph.");
a(null === s.nodeRoot, "Internal Error: Dangling root pointer detected in contact graph.");
}
if (e) for (var o = this.idleSpeedThreshold, r = o ? o * o : D(this.gravity) * t * t, n = 0; n < i.length; n++) {
var s = i[n], c = r ? s.m * r : 0;
s.nodeIdleTime = s.kineticEnergy() > c ? 0 : s.nodeIdleTime + t;
}
for (var h = this.arbiters, n = 0, l = h.length; n < l; n++) {
...
if (e) {
for (var p = this.constraints, n = 0; n < p.length; n++) {
var _ = p[n], d = _.a;
...
if (null === $t(s)) {
ie(s, s);
if (!ne(s, this.sleepTimeThreshold)) {
this.sleepingComponents.push(s);
for (var g = s; g; g = g.nodeNext) this.deactivateBody(g);
continue;
}
}
n++;
...
st.prototype.sleepWithGroup = function(t) {
...
if (this.isSleeping()) c($t(this) === $t(t), "The body is already sleeping and it's group cannot be reassigned."); else {
...
Zt.prototype.activateShapesTouchingShape = function(t) {
Infinity !== this.sleepTimeThreshold && this.shapeQuery(t, (function(t, e) {
t.body.activate();
}));
};
Zt.prototype.pointQuery = function(t, e, i, n) {
var o = function(o) {
...
Zt.prototype.pointQueryFirst = function(t, e, i) {
var n = null;
...
Zt.prototype.nearestPointQuery = function(t, e, i, n, o) {
var r = function(r) {
...
Zt.prototype.nearestPointQueryNearest = function(t, e, i, n) {
var o, r = function(r) {
...
Zt.prototype.segmentQuery = function(t, e, i, n, o) {
var r = function(r) {
var s;
...
Zt.prototype.segmentQueryFirst = function(t, e, i, n) {
...
Zt.prototype.bbQuery = function(t, e, i, n) {
var o = function(o) {
(!o.group || i !== o.group) && e & o.layers && X(t, o.bb_l, o.bb_b, o.bb_r, o.bb_t) && n(o);
};
this.lock();
...
Zt.prototype.shapeQuery = function(t, e) {
var i = t.body;
...
var r;
if (n.collisionCode <= i.collisionCode) r = qt(n, i); else {
r = qt(i, n);
for (c = 0; c < r.length; c++) r[c].n = w(r[c].n);
}
if (r.length) {
o = !(n.sensor || i.sensor);
if (e) {
for (var s = new Array(r.length), c = 0; c < r.length; c++) s[c] = new Dt(r[c].p, r[c].n, r[c].dist);
e(i, s);
}
}
}
...
Zt.prototype.addPostStepCallback = function(t) {
...
Zt.prototype.runPostStepCallbacks = function() {
for (var t = 0; t < this.postStepCallbacks.length; t++) this.postStepCallbacks[t]();
this.postStepCallbacks = [];
};
Zt.prototype.lock = function() {
this.locked++;
};
Zt.prototype.unlock = function(t) {
...
Zt.prototype.makeCollideShapes = function() {
var t = this;
return function(e, i) {
var n = t;
...
var c = qt(e, i);
if (0 !== c.length) {
var a = h(e.hashid, i.hashid), l = n.cachedArbiters[a];
l || (l = n.cachedArbiters[a] = new Bt(e, i));
l.update(c, o, e, i);
"first coll" != l.state || o.begin(l, n) || l.ignore();
if ("ignore" !== l.state && o.preSolve(l, n) && !r) n.arbiters.push(l); else {
l.contacts = null;
"ignore" !== l.state && (l.state = "normal");
}
l.stamp = n.stamp;
}
}
...
Zt.prototype.arbiterSetFilter = function(t) {
...
Zt.prototype.step = function(t) {
if (0 !== t) {
c(0 === b.x && 0 === b.y, "vzero is invalid");
this.stamp++;
var e = this.curr_dt;
this.curr_dt = t;
...
return new m(s - o, c - r);
}, se = function(t, e, i, n, o) {
var r = t.vx + -i.y * t.w, s = t.vy + i.x * t.w, c = e.vx + -n.y * e.w, a = e.vy + n.x * e.w;
return T(c - r, a - s, o.x, o.y);
}, ce = function(t, e, i, n) {
t.vx += e * t.m_inv;
t.vy += i * t.m_inv;
t.w += t.i_inv * (n.x * i - n.y * e);
}, ae = function(t, e, i, n, o, r) {
ce(t, -o, -r, i);
ce(e, o, r, n);
}, he = function(t, e, i, n) {
t.v_biasx += e * t.m_inv;
t.v_biasy += i * t.m_inv;
t.w_bias += t.i_inv * N(n.x, n.y, e, i);
}, le = function(t, e, i) {
var n = I(e, i);
return t.m_inv + t.i_inv * n * n;
}, ue = function(t, e, i, n, o) {
var r = le(t, i, o) + le(e, n, o);
a(0 !== r, "Unsolvable collision or constraint.");
return r;
}, de = function(t, e, i, n, o, r) {
...
return new m(C(t, e), C(t, i));
}, pe = function(t, e) {
return 1 - Math.pow(t, e);
}, _e = cp.Constraint = function(t, e) {
this.a = t;
this.b = e;
this.space = null;
this.next_a = null;
...
_e.prototype.preSolve = function(t) {};
_e.prototype.postSolve = function(t) {};
_e.prototype.next = function(t) {
return this.a === t ? this.next_a : this.next_b;
};
var ge = cp.PinJoint = function(t, e, i, n) {
_e.call(this, t, e);
this.anchr1 = i;
this.anchr2 = n;
var o = t ? x(t.p, P(i, t.rot)) : i, r = e ? x(e.p, P(n, e.rot)) : n;
this.dist = E(A(r, o));
...
ge.prototype = Object.create(_e.prototype);
ge.prototype.preStep = function(t) {
var e = this.a, i = this.b;
this.r1 = P(this.anchr1, e.rot);
this.r2 = P(this.anchr2, i.rot);
var n = A(x(i.p, this.r2), x(e.p, this.r1)), o = E(n);
this.n = O(n, 1 / (o || Infinity));
this.nMass = 1 / ue(e, i, this.r1, this.r2, this.n);
var r = this.maxBias;
this.bias = v(-pe(this.errorBias, t) * (o - this.dist) / t, -r, r);
this.jnMax = this.maxForce * t;
};
ge.prototype.applyCachedImpulse = function(t) {
var e = O(this.n, this.jnAcc * t);
ae(this.a, this.b, this.r1, this.r2, e.x, e.y);
};
ge.prototype.applyImpulse = function() {
var t = this.a, e = this.b, i = this.n, n = se(t, e, this.r1, this.r2, i), o = (this.bias - n) * this.nMass, r = this.jnAcc;
this.jnAcc = v(r + o, -this.jnMax, this.jnMax);
o = this.jnAcc - r;
ae(t, e, this.r1, this.r2, i.x * o, i.y * o);
};
ge.prototype.getImpulse = function() {
return Math.abs(this.jnAcc);
};
var ve = cp.SlideJoint = function(t, e, i, n, o, r) {
_e.call(this, t, e);
this.anchr1 = i;
this.anchr2 = n;
this.min = o;
...
ve.prototype = Object.create(_e.prototype);
ve.prototype.preStep = function(t) {
var e = this.a, i = this.b;
this.r1 = P(this.anchr1, e.rot);
this.r2 = P(this.anchr2, i.rot);
var n = A(x(i.p, this.r2), x(e.p, this.r1)), o = E(n), r = 0;
if (o > this.max) {
r = o - this.max;
this.n = k(n);
} else if (o < this.min) {
...
this.nMass = 1 / ue(e, i, this.r1, this.r2, this.n);
var s = this.maxBias;
this.bias = v(-pe(this.errorBias, t) * r / t, -s, s);
this.jnMax = this.maxForce * t;
};
ve.prototype.applyCachedImpulse = function(t) {
var e = this.jnAcc * t;
ae(this.a, this.b, this.r1, this.r2, this.n.x * e, this.n.y * e);
};
ve.prototype.applyImpulse = function() {
if (0 !== this.n.x || 0 !== this.n.y) {
var t = this.a, e = this.b, i = this.n, n = this.r1, o = this.r2, r = re(t, e, n, o), s = C(r, i), c = (this.bias - s) * this.nMass, a = this.jnAcc;
this.jnAcc = v(a + c, -this.jnMax, 0);
c = this.jnAcc - a;
ae(t, e, this.r1, this.r2, i.x * c, i.y * c);
}
};
ve.prototype.getImpulse = function() {
return Math.abs(this.jnAcc);
};
var ye = cp.PivotJoint = function(i, n, o, r) {
_e.call(this, i, n);
if ("undefined" === ("object" == (e = typeof r) ? t(r) : e)) {
var s = o;
...
ye.prototype = Object.create(_e.prototype);
ye.prototype.preStep = function(t) {
var e = this.a, i = this.b;
this.r1 = P(this.anchr1, e.rot);
this.r2 = P(this.anchr2, i.rot);
de(e, i, this.r1, this.r2, this.k1, this.k2);
this.jMaxLen = this.maxForce * t;
var n = A(x(i.p, this.r2), x(e.p, this.r1));
this.bias = z(O(n, -pe(this.errorBias, t) / t), this.maxBias);
};
ye.prototype.applyCachedImpulse = function(t) {
ae(this.a, this.b, this.r1, this.r2, this.jAcc.x * t, this.jAcc.y * t);
};
ye.prototype.applyImpulse = function() {
var t = this.a, e = this.b, i = this.r1, n = this.r2, o = re(t, e, i, n), r = fe(A(this.bias, o), this.k1, this.k2), s = this.jAcc;
this.jAcc = z(x(this.jAcc, r), this.jMaxLen);
ae(t, e, this.r1, this.r2, this.jAcc.x - s.x, this.jAcc.y - s.y);
};
ye.prototype.getImpulse = function() {
return E(this.jAcc);
};
var me = cp.GrooveJoint = function(t, e, i, n, o) {
_e.call(this, t, e);
this.grv_a = i;
this.grv_b = n;
this.grv_n = L(j(A(n, i)));
this.anchr2 = o;
this.grv_tn = null;
this.clamp = 0;
this.r1 = this.r2 = null;
...
me.prototype.preStep = function(t) {
var e = this.a, i = this.b, n = e.local2World(this.grv_a), o = e.local2World(this.grv_b), r = P(this.grv_n, e.rot), s = C(n, r);
this.grv_tn = r;
this.r2 = P(this.anchr2, i.rot);
var c = I(x(i.p, this.r2), r);
if (c <= I(n, r)) {
this.clamp = 1;
this.r1 = A(n, e.p);
} else if (c >= I(o, r)) {
...
this.clamp = 0;
this.r1 = A(x(O(L(r), -c), O(r, s)), e.p);
}
de(e, i, this.r1, this.r2, this.k1, this.k2);
this.jMaxLen = this.maxForce * t;
var a = A(x(i.p, this.r2), x(e.p, this.r1));
this.bias = z(O(a, -pe(this.errorBias, t) / t), this.maxBias);
};
me.prototype.applyCachedImpulse = function(t) {
ae(this.a, this.b, this.r1, this.r2, this.jAcc.x * t, this.jAcc.y * t);
};
me.prototype.grooveConstrain = function(t) {
var e = this.grv_tn, i = this.clamp * I(t, e) > 0 ? t : R(t, e);
return z(i, this.jMaxLen);
};
...
me.prototype.setGrooveA = function(t) {
this.grv_a = t;
this.grv_n = L(j(A(this.grv_b, t)));
this.activateBodies();
};
me.prototype.setGrooveB = function(t) {
this.grv_b = t;
this.grv_n = L(j(A(t, this.grv_a)));
this.activateBodies();
};
var be = function(t, e) {
return (t.restLength - e) * t.stiffness;
}, Ce = cp.DampedSpring = function(t, e, i, n, o, r, s) {
_e.call(this, t, e);
this.anchr1 = i;
this.anchr2 = n;
this.restLength = o;
...
var n = A(x(i.p, this.r2), x(e.p, this.r1)), o = E(n);
this.n = O(n, 1 / (o || Infinity));
var r = ue(e, i, this.r1, this.r2, this.n);
a(0 !== r, "Unsolvable this.");
this.nMass = 1 / r;
this.target_vrn = 0;
this.v_coef = 1 - Math.exp(-this.damping * t * r);
var s = this.springForceFunc(this, o);
ae(e, i, this.r1, this.r2, this.n.x * s * t, this.n.y * s * t);
};
Ce.prototype.applyCachedImpulse = function(t) {};
Ce.prototype.applyImpulse = function() {
var t = this.a, e = this.b, i = this.n, n = this.r1, o = this.r2, r = se(t, e, n, o, i), s = (this.target_vrn - r) * this.v_coef;
this.target_vrn = r + s;
s *= this.nMass;
ae(t, e, this.r1, this.r2, this.n.x * s, this.n.y * s);
};
...
}, Ee = cp.DampedRotarySpring = function(t, e, i, n, o) {
_e.call(this, t, e);
this.restAngle = i;
this.stiffness = n;
this.damping = o;
...
var Se = cp.RotaryLimitJoint = function(t, e, i, n) {
_e.call(this, t, e);
this.min = i;
this.max = n;
this.jAcc = 0;
...
var r = this.maxBias;
this.bias = v(-pe(this.errorBias, t) * o / t, -r, r);
...
this.bias < 0 ? this.jAcc = v(o + n, 0, this.jMax) : this.jAcc = v(o + n, -this.jMax, 0);
n = this.jAcc - o;
t.w -= n * t.i_inv;
e.w += n * e.i_inv;
}
...
var xe = cp.RatchetJoint = function(t, e, i, n) {
_e.call(this, t, e);
this.angle = 0;
this.phase = i;
this.ratchet = n;
...
xe.prototype.preStep = function(t) {
...
var h = this.maxBias;
this.bias = v(-pe(this.errorBias, t) * a / t, -h, h);
this.jMax = this.maxForce * t;
this.bias || (this.jAcc = 0);
};
...
this.jAcc = v((r + o) * n, 0, this.jMax * Math.abs(n)) / n;
o = this.jAcc - r;
t.w -= o * t.i_inv;
e.w += o * e.i_inv;
}
};
xe.prototype.getImpulse = function(t) {
return Math.abs(t.jAcc);
};
var Ae = cp.GearJoint = function(t, e, i, n) {
_e.call(this, t, e);
this.phase = i;
this.ratio = n;
this.ratio_inv = 1 / n;
...
Ae.prototype = Object.create(_e.prototype);
Ae.prototype.preStep = function(t) {
var e = this.a, i = this.b;
this.iSum = 1 / (e.i_inv * this.ratio_inv + this.ratio * i.i_inv);
var n = this.maxBias;
this.bias = v(-pe(this.errorBias, t) * (i.a * this.ratio - e.a - this.phase) / t, -n, n);
this.jMax = this.maxForce * t;
};
Ae.prototype.applyCachedImpulse = function(t) {
var e = this.a, i = this.b, n = this.jAcc * t;
...
this.jAcc = v(o + n, -this.jMax, this.jMax);
n = this.jAcc - o;
...
Ae.prototype.setRatio = function(t) {
this.ratio = t;
this.ratio_inv = 1 / t;
this.activateBodies();
};
var we = cp.SimpleMotor = function(t, e, i) {
_e.call(this, t, e);
this.rate = i;
this.jAcc = 0;
...
we.prototype.preStep = function(t) {
...
this.jAcc = v(n + i, -this.jMax, this.jMax);
i = this.jAcc - n;
t.w -= i * t.i_inv;
e.w += i * e.i_inv;
};
...
"use strict";
function n(t, e) {
return "if(typeof " + t + '=="undefined")' + t + "=" + e + ";";
}
function o(t) {
...
r(cc.js.formatStr.apply(null, t));
};
} catch (t) {}
Function(n("CC_TEST", o("tap") + "||" + o("QUnit")) + n("CC_EDITOR", o("Editor") + "&&" + o("process") + '&&"electron" in process.versions') + n("CC_PREVIEW", "!CC_EDITOR") + n("CC_DEV", !0) + n("CC_DEBUG", !0) + n("CC_JSB", o("jsb")) + n("CC_BUILD", !1))();
...
t("../cocos2d/core/event-manager/CCSystemEvent");
t("../CCDebugger");
var s = t("../cocos2d/core/platform/CCMacro");
void 0 !== window.__ENABLE_GC_FOR_NATIVE_OBJECTS__ && (s.ENABLE_GC_FOR_NATIVE_OBJECTS = window.__ENABLE_GC_FOR_NATIVE_OBJECTS__);
t("./jsb-game");
t("./jsb-loader");
t("./jsb-director");
...
-1 === d.indexOf("Ease") && (function(t, e) {
var i = t[0].toLowerCase() + t.substr(1);
cc[i] = function(...t) {
var i = e.create.apply(this, t);
i.retain();
i._retained = !0;
return i;
};
...
cc.Sequence.prototype._ctor = function(...t) {
var e = t[0] instanceof Array ? t[0] : t;
if (1 !== e.length) {
var i = e.length - 1;
i >= 0 && null == e[i] && cc.logID(1015);
i >= 0 && this.init(e);
...
cc.sequence = function(...t) {
var e = t[0] instanceof Array ? t[0] : t;
return new cc.Sequence(e);
};
cc.Spawn.prototype._ctor = function(...t) {
var e = t[0] instanceof Array ? t[0] : t;
1 === e.length && cc.errorID(1020);
var i = e.length - 1;
i >= 0 && null == e[i] && cc.logID(1015);
i >= 0 && this.init(e);
if (!l) {
...
e && (e = e._owner || e);
t.call(this, e, i);
}, o = e ? cc.CallFunc.create(n, e) : cc.CallFunc.create(n);
if (!l) {
o.retain();
o._retained = !0;
}
...
if (!l) {
o(cc.ActionInterval.prototype, "repeat");
o(cc.ActionInterval.prototype, "repeatForever");
o(cc.ActionInterval.prototype, "easing");
var g = cc.Node.prototype.runAction;
cc.Node.prototype.runAction = function(t) {
g.call(this, t);
if (t._retained) {
t.release();
t._retained = !1;
...
var v = cc.ActionManager.prototype.addAction;
...
for (var y = [ [ "removeAllActionsFromTarget", 0 ], [ "removeActionByTag", 1 ], [ "getActionByTag", 1 ], [ "getNumberOfRunningActionsInTarget", 0 ], [ "pauseTarget", 0 ], [ "resumeTarget", 0 ] ], m = 0; m < y.length; ++m) (function(t, e) {
var i = cc.ActionManager.prototype, n = i[t];
i[t] = function(...t) {
for (var i = 0; i < t.length; i++) i === e && (t[i] = r(t[i]));
...
for (var C in b) {
var T = cc[C];
T.prototype._jsbUpdate = T.prototype.update;
T.prototype.update = b[C];
}
}), {} ],
198: [ (function(t, e, i) {
cc.Audio = function(t) {
...
var n = this.display;
jsb.registerNativeRef(this, n);
n.addEvent(t, e, i);
};
r.removeEventListener = function(t, e, i) {
var n = this.display;
jsb.unregisterNativeRef(this, n);
n.removeEvent(t, e, i);
};
}), {} ],
202: [ (function(t, e, i) {
...
var s = 0;
cc.Scheduler.prototype.schedule = function(t, e, i, n, o, r) {
if (void 0 === o || void 0 === r) {
r = !!n;
n = cc.macro.REPEAT_FOREVER;
} else {
r = !!r;
n = isFinite(n) ? n : cc.macro.REPEAT_FOREVER;
}
o = o || 0;
var c = e.__instanceId || e.uuid;
cc.assertID(!isNaN(c), 1510);
t.__callbackId || (t.__callbackId = s++);
var a = c + "_" + t.__callbackId;
this._schedule(e, t, i, n, o, r, a);
};
...
cc.Scheduler.prototype.unschedule = function(i, n) {
if ("function" === ("object" == (e = typeof n) ? t(n) : e)) {
var o = n;
n = i;
i = o;
}
var r = n.__instanceId || n.uuid;
cc.assertID(!isNaN(r) && !isNaN(i.__callbackId), 1510);
var s = r + "_" + i.__callbackId;
this._unschedule(s, n);
};
var c = cc.Node.prototype;
cc.defineGetterSetter(c, "_parent", c.getParent, c.setParent);
cc.view.isViewReady = cc.view.isOpenGLReady;
cc.view.setOrientation = function() {};
var a = 0, h = {}, l = function(t) {
this.__instanceId = cc.ClassManager.getNewInstanceId();
this._intervalId = a++;
this._code = t;
};
...
window.setTimeout = function(t, e, ...i) {
var n = new l(t);
i.length > 0 && (n._args = i);
var o = n.fun;
n.fun = function() {
o.call(this);
clearTimeout(n._intervalId);
};
cc.director.getScheduler().schedule(n.fun, n, e / 1e3, 0, 0, !1);
h[n._intervalId] = n;
return n._intervalId;
};
window.setInterval = function(t, e, ...i) {
var n = new l(t);
i.length > 0 && (n._args = i);
cc.director.getScheduler().schedule(n.fun, n, e / 1e3, cc.macro.REPEAT_FOREVER, 0, !1);
h[n._intervalId] = n;
return n._intervalId;
};
...
this._labelType !== _ccsg.Label.Type.SystemFont && this._setLineHeight(t);
};
...
(c = r.createWithTTF(a, t, this._fontSize))._ttfConfig = a;
} else if (i) {
...
jsb.unregisterNativeRef(cc.textureCache, o);
};
...
} ], o = cc.ParticleSystem.prototype, r = 0; r < n.length; r++) {
var s = n[r];
for (var c in s) {
var a = s[c], h = o[a];
o[a] = (function(t, e) {
...
var l = a.replace("set", "get");
cc.defineGetterSetter(o, c, o[l], o[a]);
}
}
}), {} ],
210: [ (function(t, e, i) {
...
if (null != i && "function" === ("object" == (e = typeof Object.getOwnPropertySymbols) ? t(Object.getOwnPropertySymbols) : e)) for (var s = 0, r = Object.getOwnPropertySymbols(i); s < r.length; s++) n.indexOf(r[s]) < 0 && (o[r[s]] = i[r[s]]);
return o;
};
...
for (;l; ) try {
if (s = 1, c && (a = c[2 & t[0] ? "return" : t[0] ? "throw" : "next"]) && !(a = a.call(c, t[1])).done) return a;
(c = 0, a) && (t = [ 0, a.value ]);
switch (t[0]) {
case 0:
case 1:
...
default:
if (!(a = l.trys, a = a.length > 0 && a[a.length - 1]) && (6 === t[0] || 2 === t[0])) {
l = 0;
continue;
}
...
throw: o(1),
return: o(2)
}, "function" === ("object" == (e = typeof Symbol) ? t(Symbol) : e) && (h[Symbol.iterator] = function() {
return this;
}), h;
};
...
function r(t) {
t.value instanceof __await ? Promise.resolve(t.value.v).then(s, c) : a(u[0][2], t);
}
function s(t) {
o("next", t);
}
...
function a(t, e) {
(t(e), u.shift(), u.length) && o(u[0][0], u[0][1]);
}
if (!Symbol.asyncIterator) throw new TypeError("Symbol.asyncIterator is not defined.");
var h, l = i.apply(t, e || []), u = [];
return h = {}, n("next"), n("throw"), n("return"), h[Symbol.asyncIterator] = function() {
return this;
}, h;
};

...
public class UnityEngine_LineRendererWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("numPositions", get_numPositions, set_numPositions);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_numPositions(IntPtr L)
	{
		object o = null;
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index numPositions on a nil value" : e.Message);
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_numPositions(IntPtr L)
	{
		object o = null;

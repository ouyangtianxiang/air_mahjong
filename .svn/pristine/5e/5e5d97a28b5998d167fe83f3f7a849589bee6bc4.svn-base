...
export class U_room_hu {
    public static table: Table<U_room_hu> = new Table<U_room_hu>(U_room_hu);
	/**
	 * $
	 */
	public id:number;
	 ...
	 * 
	 */
	public tianHU:boolean;

	/**
	 * 
	 */
	public minSevenPairs:boolean;

	/**
	 * 
	 */
	public thirteenRotten:boolean;

	/**
	 * 
	 */
	public mevius:boolean;

	/**
	 * 
	 */
	public deGuo:boolean;

	/**
	 * 
	 */
	public maxSevenPairs:boolean;
	 ...
	 * 
	 */
	public gangKai:boolean;

	/**
	 * 
	 */
	public deZhongDe:boolean;

	/**
	 * 
	 */
	public jingDiao:boolean;
...
export var Beans: object = { "U_room": U_room,"U_room_hu": U_room_hu,"U_data": U_data,"T_tile": T_tile,"U_info": U_info,"T_state": T_state,"U_room_level": U_room_level,"T_play": T_play };